...
<img src="/safekit-docs/wp-content/uploads/2026/04/safekit-icon-512x512-1.png" width="128" alt="Logo officiel Evidian SafeKit - Logiciel de haute disponibilité et de clustering d'applications sans SAN (SANless)">
...
- **Aucun coût caché :** Tous les [modules applicatifs de HA pré-configurés](/safekit-docs/fr/#safekit-ha-application-modules "Explorez les modules applicatifs de HA pré-configurés gratuits") sont fournis gratuitement.
- **Évaluation sans risque :** Téléchargez un [essai gratuit de 30 jours](/safekit-docs/fr/#safekit-ha-technical-resources "Télécharger l'essai gratuit de 30 jours de SafeKit") pour tester le basculement et la réplication dans votre environnement.
...
<img src="/safekit-docs/wp-content/uploads/2026/05/safekit-vms-512-512.jpg" alt="SafeKit pour VMS">
...
<img src="/safekit-docs/wp-content/uploads/2026/05/safekit-eacs-512-512.jpg" alt="SafeKit pour EACS">
...
<img src="/safekit-docs/wp-content/uploads/2026/05/safekit-scada-512-512.jpg" alt="SafeKit pour le SCADA">
...
<img src="/safekit-docs/wp-content/uploads/2026/05/safekit-bms-512-512.jpg" alt="SafeKit pour le BMS">
...
<img src="/safekit-docs/wp-content/uploads/2026/05/safekit-atc-512-512.jpg" alt="SafeKit pour l'ATC">
...
<img src="/safekit-docs/wp-content/uploads/2026/05/safekit-occ-512-512.jpg" alt="SafeKit pour l'OCC">
...
Temps de resynchronisation après une panne ([étape 3](/safekit-docs/architectures/file-replication-byte-level-with-failover-mirror-cluster/#safekit-mirror-cluster))
...
- Pour un volume de données important, utiliser un [stockage partagé externe](/safekit-docs/best-practises/san-vs-nas-shared-storage-for-a-failover-cluster/).
- Plus coûteux, plus complexe.

### Pourquoi une réplication < 1 000 000 fichiers ?

- Performance du temps de resynchronisation après une panne ([étape 3](/safekit-docs/architectures/file-replication-byte-level-with-failover-mirror-cluster/#safekit-mirror-cluster)).
...
- Basculement automatique de l’[adresse IP virtuelle](/safekit-docs/best-practises/how-a-virtual-ip-address-works/) avec 2 nœuds dans le même sous-réseau.
- Bonne bande passante pour la resynchronisation ([étape 3](/safekit-docs/architectures/file-replication-byte-level-with-failover-mirror-cluster/#safekit-mirror-cluster)) et bonne latence pour la [réplication synchrone](/safekit-docs/best-practises/synchronous-replication-vs-asynchronous-replication/) (typiquement un aller-retour inférieur à 2 ms).

#### Alternative

- Utiliser un [load balancer pour l’adresse IP virtuelle](/safekit-docs/best-practises/how-a-virtual-ip-address-works/) si les 2 nœuds sont dans 2 sous-réseaux (pris en charge par SafeKit, notamment dans le cloud).
...
1. [Introduction](https://www.youtube.com/watch?v=UiLwzqsMxis&t=0s) (0:38)
2. [Démonstration de SafeKit](https://www.youtube.com/watch?v=UiLwzqsMxis&t=38s) (1:41)
3. [Exemples de redondance et de solution de haute disponibilité](https://www.youtube.com/watch?v=UiLwzqsMxis&t=139s) (2:00)
4. [SafeKit vendu dans de nombreux pays avec Milestone](https://www.youtube.com/watch?v=UiLwzqsMxis&t=259s) (0:49)
5. [Choisir entre 2 solutions : machine virtuelle ou cluster applicatif](https://www.youtube.com/watch?v=UiLwzqsMxis&t=308s) (2:29)
6. [Avantages distinctifs](https://www.youtube.com/watch?v=UiLwzqsMxis&t=457s) (2:06)

[Toutes les vidéos ici](/safekit-docs/resources/safekit-on-line-training/)
...
1. [Introduction à SafeKit HADR sur VLAN étendus](https://www.youtube.com/watch?v=g5zcTjiY7T4&t=0s) (1:06)
2. [Fonctionnement de la réplication synchrone et du double acquittement](https://www.youtube.com/watch?v=g5zcTjiY7T4&t=65s) (1:41)
3. [Mécanismes de basculement : ARP gratuit (GARP) et IP virtuelle](https://www.youtube.com/watch?v=g5zcTjiY7T4&t=166s) (2:10)
4. [Conception pour WAN lent : stratégies de haute disponibilité vs sauvegarde](https://www.youtube.com/watch?v=g5zcTjiY7T4&t=296s) (2:45)

[En savoir plus sur SafeKit HADR](/safekit-docs/best-practises/high-availability-disaster-recovery-hadr/)
...
1. [2 nœuds Hyper-V et 2 machines virtuelles](https://www.youtube.com/watch?v=foo6YKg5Dmw&t=0s) (0:49)
2. [Configuration du cluster et de deux modules hyperv.safe](https://www.youtube.com/watch?v=foo6YKg5Dmw&t=49s) (1:59)
3. [Démarrage et test de la réplication de VM, migration et basculement sur panne](https://www.youtube.com/watch?v=foo6YKg5Dmw&t=168s) (2:26)

[Essai gratuit ici](/safekit-docs/quick-install/safekit-quick-installation-guide-with-hyper-v/)
...
1. [2 nœuds avec SQL Server](https://www.youtube.com/watch?v=T_6PsS4f9OQ&t=0s) (0:32)
2. [Configuration du cluster et du module mirror.safe](https://www.youtube.com/watch?v=T_6PsS4f9OQ&t=32s) (3:58)
3. [Démarrage et test de la réplication SQL, migration et basculement sur panne](https://www.youtube.com/watch?v=T_6PsS4f9OQ&t=270s) (4:17)
...
1. [SafeKit pour l'intégration OEM](https://www.youtube.com/watch?v=dxiPG5ILC-0&t=0s) (0:09)
2. [Exemple de configuration OEM : Milestone XProtect](https://www.youtube.com/watch?v=dxiPG5ILC-0&t=9s) (2:18)
3. [Explication des scénarios de basculement](https://www.youtube.com/watch?v=dxiPG5ILC-0&t=138s) (1:49)
4. [Conclusion : Ajoutez la haute disponibilité OEM à votre catalogue](https://www.youtube.com/watch?v=dxiPG5ILC-0&t=247s) (0:15)
...
1. [2 nœuds avec Apache](https://www.youtube.com/watch?v=XSMV_eM-jgk&t=0s) (0:13)
2. [Configuration du cluster et du module farm.safe](https://www.youtube.com/watch?v=XSMV_eM-jgk&t=13s) (2:20)
3. [Démarrage et test de la répartition de charge réseau et du basculement sur panne](https://www.youtube.com/watch?v=XSMV_eM-jgk&t=153s) (2:30)
...
1. [La plateforme de formation et de certification](https://www.youtube.com/watch?v=ijH4zXtn_3s&t=0s) (1:41)
2. [Qu'est-ce qu'un module de formation SafeKit ?](https://www.youtube.com/watch?v=ijH4zXtn_3s&t=101s) (1:57)
3. [Comment obtenir une certification SafeKit ?](https://www.youtube.com/watch?v=ijH4zXtn_3s&t=218s) (1:40)
4. [Partager votre certification sur LinkedIn](https://www.youtube.com/watch?v=ijH4zXtn_3s&t=318s) (0:53)
...
1. [Introduction](https://www.youtube.com/watch?v=DKra6YVLGZk&t=0s) (4:10)
2. [Cluster de machines virtuelles](https://www.youtube.com/watch?v=DKra6YVLGZk&t=250s) (1:20)
3. [Cluster miroir (Mirror)](https://www.youtube.com/watch?v=DKra6YVLGZk&t=330s) (6:04)
4. [Cluster ferme (Farm)](https://www.youtube.com/watch?v=DKra6YVLGZk&t=694s) (1:46)

[Voir la comparaison SafeKit vs Cluster HA traditionnel](/safekit-docs/#safekit-ha-comparison "Comparaison détaillée du logiciel SafeKit par rapport aux clusters HA matériels traditionnels")

### Vidéo SafeKit : Console sur Smartphone (0:54) {#demo-console}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt;

### Vidéo SafeKit : Notifications par E-mail sur Bascule (1:04) {#demo-notifications}
...
💡 Pour démarrer votre parcours de haute disponibilité avec SafeKit, **[commencez par les Guides d'Installation Rapide](/safekit-docs/quick-install/)**.
...
| -------------------------- | ------------------------- | ---------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Toutes plateformes**     | **Document PDF**          | **Bulletin officiel de version (Support OS & Correctifs)** | [📄 Voir le SRB SafeKit 8.2](/safekit-docs/wp-content/uploads/downloads_safekit/version-82/82softwarereleasebulletin.pdf "Bulletin officiel détaillant les OS supportés et les correctifs récents pour SafeKit 8.2.")                                                                        |
...
➡️ [Obtenez Votre Clé d'Essai Gratuite d'1 Mois pour Tester la Haute Disponibilité de SafeKit](https://safekit.eviden.com/resources/safekit-free-trial-licence-key-high-availability/ "Demandez votre clé de licence d'essai gratuite de 30 jours pour la Haute Disponibilité SafeKit")

### 📚 Guides de Configuration SafeKit pour Votre Cluster HA {#config-guides-heading}

Documentation essentielle pour la configuration et la gestion de votre Cluster de Haute Disponibilité SafeKit.

- [Guides d'Installation Rapide SafeKit](/safekit-docs/quick-install/ "Démarrez rapidement avec les Guides d'Installation Rapide de SafeKit.")
- [Guide Utilisateur SafeKit HTML (Version 8.2)](/safekit-docs/fr/resources/safekit-user-guide-82/ "Consulter le guide utilisateur complet de SafeKit version 8.2 (HTML).") / [Télécharger PDF](/safekit-docs/wp-content/uploads/downloads_safekit/version-82/safekituserguidefr.pdf "Consulter le guide utilisateur complet de SafeKit version 8.2 (PDF).")
- [Notes de Version SafeKit HTML (Version 8.2)](/safekit-docs/resources/safekit-release-notes-8-2/ "Voir les nouveautés, changements et correctifs de SafeKit version 8.2 (HTML).") / [Télécharger PDF](/safekit-docs/wp-content/uploads/downloads_safekit/version-82/safekit82releasenotes.pdf "Voir les nouveautés, changements et correctifs de SafeKit version 8.2 (PDF).")

### 📞/🤖 Support SafeKit {#support}

- 📞 [Support payant](/safekit-docs/fr/resources/safekit-support/#standard-support) / 🤖 [Support gratuit](/safekit-docs/fr/resources/safekit-support/#ai-support)
...
- [Fiche Technique du Cluster de Haute Disponibilité SafeKit (PDF)](/safekit-docs/wp-content/uploads/documents/high-availability-overview-fr.pdf)
- [Livre Blanc sur la Technologie de Cluster de Haute Disponibilité (PDF)](/safekit-docs/wp-content/uploads/documents/wp-safekit-fr.pdf)
- [Livre blanc – Guide de haute disponibilité (PDF) ](/safekit-docs/wp-content/uploads/documents/wp-hadecision-fr.pdf)
- [Référence technique pour la préparation des RFI et RFP](/safekit-docs/fr/resources/high-availability-technical-reference-for-rfi-and-rfp-preparation/)
