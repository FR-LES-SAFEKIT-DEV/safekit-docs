---
title: "SafeKit : logiciel tout-en-un de haute disponibilité « SANless » et de clustering d'applications - SafeKit HA"
canonical: "https://safekit.eviden.com/fr/"
description: "SafeKit est le logiciel de haute disponibilité (HA) « SANless » tout-en-un pour Windows et Linux. Bénéficiez de la réplication synchrone en temps réel, du basculement automatique et de la répartition de charge dans un package simple et économique. Commencez votre essai gratuit de 30 jours."
category: "home"
lang: "fr"
topics: "Qu'est-ce que SafeKit ?, 🔍 Hub de navigation SafeKit Haute Disponibilité, Pourquoi choisir SafeKit pour une haute disponibilité simple et économique ?, Cas d'usage de SafeKit, Pourquoi un produit de haute disponibilité « SANless » tout-en-un est-il essentiel ?, Choisir sa stratégie de haute disponibilité : HA VM vs HA applicative, Limitations de la haute disponibilité de SafeKit, Tutoriels techniques et démos sur le basculement SafeKit, Comment fonctionne le cluster miroir SafeKit avec Windows/Linux ?, Comment fonctionne le cluster SafeKit en mode farm avec Windows/Linux ?, Comparaison de SafeKit avec les clusters de Haute Disponibilité (HA) traditionnels, Différences architecturales : SafeKit défini par logiciel vs. Clusters HA Matériels, Principaux Éléments Différenciateurs du Cluster Miroir SafeKit, Principaux Éléments Différenciateurs du Cluster Farm SafeKit, Haute Disponibilité VM : SafeKit sans SAN vs. Hyper-V/VMware HA, Ressources, Téléchargements et Documentation sur la Haute Disponibilité SafeKit, Bibliothèque des modules applicatifs SafeKit : solutions HA prêtes à l’emploi"
---
...
![Logo officiel Evidian SafeKit - Logiciel de haute disponibilité et de clustering d'applications sans SAN (SANless)](/wp-content/uploads/2026/04/safekit-icon-512x512-1.png "w:128")
...
<!-- BEGIN INSERT: insert-safekit-feature-en lang="fr" display="content" -->
 

## Pourquoi choisir SafeKit pour une haute disponibilité simple et économique ? {#why-choose-safekit-for-ha}
...
**SafeKit** propose un **modèle de licence par nœud** transparent et économique, basé strictement sur le nombre de serveurs, sans tenir compte du nombre de cœurs CPU ou de sockets. Contrairement à de nombreux concurrents en haute disponibilité qui imposent des abonnements récurrents, SafeKit offre des **licences perpétuelles** pour garantir un coût total de possession (TCO) réduit et une valorisation de vos actifs logiciels à long terme.
  ...
  * **Aucun coût caché :** Tous les [modules applicatifs de HA pré-configurés](</fr/#safekit-ha-application-modules> "Explorez les modules applicatifs de HA pré-configurés gratuits") sont fournis gratuitement.
  * **Évaluation sans risque :** Téléchargez un [essai gratuit de 30 jours](</fr/#safekit-ha-technical-resources> "Télécharger l'essai gratuit de 30 jours de SafeKit") pour tester le basculement et la réplication dans votre environnement.
  * **Devis personnalisés :** N'hésitez pas à **[nous contacter pour un devis](<https://safekit.eviden.com/fr/get-a-quote-safekit/> "Demander un devis personnalisé pour SafeKit")** adapté à vos besoins spécifiques en haute disponibilité.



<!-- END INSERT: insert-safekit-feature-en lang="fr" display="content" -->
 


<!-- BEGIN INSERT: insert-safekit-use-cases-en lang="fr" display="content" -->
 

## Cas d'usage de SafeKit {#safekit-use-cases}
...
![SafeKit pour VMS](/wp-content/uploads/2026/05/safekit-vms-512-512.jpg)
...
![SafeKit pour EACS](/wp-content/uploads/2026/05/safekit-eacs-512-512.jpg)
...
![SafeKit pour le SCADA](/wp-content/uploads/2026/05/safekit-scada-512-512.jpg)
...
![SafeKit pour le BMS](/wp-content/uploads/2026/05/safekit-bms-512-512.jpg)
...
![SafeKit pour l'ATC](/wp-content/uploads/2026/05/safekit-atc-512-512.jpg)
...
![SafeKit pour l'OCC](/wp-content/uploads/2026/05/safekit-occ-512-512.jpg)
...
<!-- END INSERT: insert-safekit-use-cases-en lang="fr" display="content" -->
 


<!-- BEGIN INSERT: insert-safekit-sanless-en lang="fr" display="content" -->
 

## Pourquoi un produit de haute disponibilité « SANless » tout-en-un est-il essentiel ? {#all-in-one-sanless-ha}
...
<!-- END INSERT: insert-safekit-sanless-en lang="fr" display="content" -->
 


<!-- BEGIN INSERT: insert-vm-vs-app-ha-en lang="fr" display="content" -->
 

## Choisir sa stratégie de haute disponibilité : HA VM vs HA applicative {#safekit-ha-redundancy-choices}
...
Configuration | Solution générique pour toute application / OS exécuté dans la VM. <br>• Ne nécessite pas une connaissance technique de l’application installée dans la VM.<br>• Solution idéale si vous ne connaissez pas le fonctionnement interne de l’application.<br>• Il suffit de définir l’emplacement des fichiers de la VM.  | Nécessite une compréhension technique de l’application elle-même. <br>• Quels services doivent être redémarrés.<br>• Les répertoires applicatifs à répliquer en temps réel.<br>• La configuration d’une adresse IP virtuelle pour le basculement.   
...
<!-- END INSERT: insert-vm-vs-app-ha-en lang="fr" display="content" -->
 


<!-- BEGIN INSERT: insert-safekit-usage-en lang="fr" display="content" -->
 

## Limitations de la haute disponibilité de SafeKit {#safekit-ha-limitations}

Limite / Prérequis | Raison & Impact | Alternative recommandée  
---|---|---  
Taille de réplication : Quelques To |  Temps de resynchronisation après une panne ([étape 3](</architectures/file-replication-byte-level-with-failover-mirror-cluster/#safekit-mirror-cluster>)) : <br>• Réseau 1 Gbit/s ≈ 3 heures / To<br>• Réseau 10 Gbit/s ≈ 1 heure / To (selon les performances d'écriture sur disque)  |  • Utiliser un [stockage partagé externe](/best-practises/san-vs-nas-shared-storage-for-a-failover-cluster/) (plus coûteux, plus complexe).   
Nombre de fichiers : < 1 000 000 de fichiers |  • Performance du temps de resynchronisation après une panne ([étape 3](/architectures/file-replication-byte-level-with-failover-mirror-cluster/#safekit-mirror-cluster)).<br>• Temps nécessaire pour vérifier chaque fichier entre les deux nœuds.  |  • Placer le grand nombre de fichiers à répliquer dans un disque dur virtuel / une machine virtuelle.<br>• Dans ce cas, seuls les fichiers représentant le disque dur virtuel / la machine virtuelle seront répliqués et resynchronisés.   
Capacité de basculement : ≤ 32 VM |  • Chaque VM s'exécute dans un module mirror indépendant.<br>• Maximum de 32 modules mirror s'exécutant sur le même cluster.  |  • Utiliser un stockage partagé externe et une autre solution de clustering de VM (plus coûteux, plus complexe).   
Architecture réseau : Réseau LAN/VLAN entre sites distants |  • Basculement automatique de l'[adresse IP virtuelle](/best-practises/how-a-virtual-ip-address-works/) avec 2 nœuds dans le même sous-réseau.<br>• Bonne bande passante pour la resynchronisation ([étape 3](/architectures/file-replication-byte-level-with-failover-mirror-cluster/#safekit-mirror-cluster)) et faible latence pour la [réplication synchrone](/best-practises/synchronous-replication-vs-asynchronous-replication/) (généralement un aller-retour inférieur à 2 ms).  |  • Utiliser un [répartiteur de charge pour l'adresse IP virtuelle](/best-practises/how-a-virtual-ip-address-works/) si les 2 nœuds se trouvent dans 2 sous-réseaux différents (pris en charge par SafeKit, notamment dans le cloud).<br>• Utiliser des solutions de sauvegarde avec réplication asynchrone pour les réseaux à forte latence.   
  

<!-- END INSERT: insert-safekit-usage-en lang="fr" display="content" -->
 


<!-- BEGIN INSERT: insert-safekit-videos-en lang="fr" display="content" -->
 

## Tutoriels techniques et démos sur le basculement SafeKit {#safekit-failover-tutorials}

###  Vidéo SafeKit : Webinaire (9:43) {#demo-webinar}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt; 

#### Chapitres

  1. 🎬 [Introduction](<https://youtu.be/UiLwzqsMxis?t=0s>) (0:38)
  2. 🎬 [Démonstration de SafeKit](<https://youtu.be/UiLwzqsMxis?t=38s>) (1:41)
  3. 🎬 [Exemples de redondance et de solution de haute disponibilité](<https://youtu.be/UiLwzqsMxis?t=139s>) (2:00)
  4. 🎬 [SafeKit vendu dans de nombreux pays avec Milestone](<https://youtu.be/UiLwzqsMxis?t=259s>) (0:49)
  5. 🎬 [Choisir entre 2 solutions : machine virtuelle ou cluster applicatif](<https://youtu.be/UiLwzqsMxis?t=308s>) (2:29)
  6. 🎬 [Avantages distinctifs](<https://youtu.be/UiLwzqsMxis?t=457s>) (2:06)

[Toutes les vidéos ici](</resources/safekit-on-line-training/>)  


### SafeKit : Comment mettre en œuvre la HADR (6:42) {#safekit-hadr}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt; 

#### Chapitres

  1. 🎬 [Introduction à SafeKit HADR sur VLAN étendus](<https://youtu.be/g5zcTjiY7T4?t=0s>) (1:06)
  2. 🎬 [Fonctionnement de la réplication synchrone et du double acquittement](<https://youtu.be/g5zcTjiY7T4?t=65s>) (1:41)
  3. 🎬 [Mécanismes de basculement : ARP gratuit (GARP) et IP virtuelle](<https://youtu.be/g5zcTjiY7T4?t=166s>) (2:10)
  4. 🎬 [Conception pour WAN lent : stratégies de haute disponibilité vs sauvegarde](<https://youtu.be/g5zcTjiY7T4?t=296s>) (2:45)

[En savoir plus sur SafeKit HADR](</best-practises/high-availability-disaster-recovery-hadr/>)

### Vidéo SafeKit : Clustering au Niveau Machine Virtuelle (5:15) {#demo-hyperv}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt; 

#### Chapitres

  1. 🎬 [2 nœuds Hyper-V et 2 machines virtuelles](<https://youtu.be/foo6YKg5Dmw?t=0s>) (0:49)
  2. 🎬 [Configuration du cluster et de deux modules hyperv.safe](<https://youtu.be/foo6YKg5Dmw?t=49s>) (1:59)
  3. 🎬 [Démarrage et test de la réplication de VM, migration et basculement sur panne](<https://youtu.be/foo6YKg5Dmw?t=168s>) (2:26)

🛠️ [Essai gratuit ici](</quick-install/safekit-quick-installation-guide-with-hyper-v/>)

### Vidéo SafeKit : Clustering au Niveau Application avec SQL (8:47) {#demo-sql}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt; 

#### Chapitres

  1. 🎬 [2 nœuds avec SQL Server](<https://youtu.be/T_6PsS4f9OQ?t=0s>) (0:32)
  2. 🎬 [Configuration du cluster et du module mirror.safe](<https://youtu.be/T_6PsS4f9OQ?t=32s>) (3:58)
  3. 🎬 [Démarrage et test de la réplication SQL, migration et basculement sur panne](<https://youtu.be/T_6PsS4f9OQ?t=270s>) (4:17)

🛠️ [Essai gratuit ici](</quick-install/safekit-quick-installation-guide-for-a-new-windows-application-with-real-time-replication-and-failover/>)

### Vidéo SafeKit : Intégration OEM Haute Disponibilité (4:22) {#demo-milestone}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt; 

#### Chapitres

  1. 🎬 [SafeKit pour l'intégration OEM](<https://youtu.be/dxiPG5ILC-0?t=0s>) (0:09)
  2. 🎬 [Exemple de configuration OEM : Milestone XProtect](<https://youtu.be/dxiPG5ILC-0?t=9s>) (2:18)
  3. 🎬 [Explication des scénarios de basculement](<https://youtu.be/dxiPG5ILC-0?t=138s>) (1:49)
  4. 🎬 [Conclusion : Ajoutez la haute disponibilité OEM à votre catalogue](<https://youtu.be/dxiPG5ILC-0?t=247s>) (0:15)

🛠️ [Essai gratuit ici](</quick-install/safekit-quick-installation-guide-for-a-new-windows-application-with-real-time-replication-and-failover/>)

### Vidéo SafeKit : Clustering Répartition de Charge Réseau (5:03) {#demo-farm}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt; 

#### Chapitres

  1. 🎬 [2 nœuds avec Apache](<https://youtu.be/XSMV_eM-jgk?t=0s>) (0:13)
  2. 🎬 [Configuration du cluster et du module farm.safe](<https://youtu.be/XSMV_eM-jgk?t=13s>) (2:20)
  3. 🎬 [Démarrage et test de la répartition de charge réseau et du basculement sur panne](<https://youtu.be/XSMV_eM-jgk?t=153s>) (2:30)

🛠️ [Essai gratuit ici](</quick-install/safekit-quick-installation-guide-for-a-new-windows-application-with-network-load-balancing-and-failover/>)

### Vidéo SafeKit : Tutoriel Plateforme de Certification Gratuite (6:11) {#demo-certification}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt; 

#### Chapitres

  1. 🎬 [La plateforme de formation et de certification](<https://youtu.be/ijH4zXtn_3s?t=0s>) (1:41)
  2. 🎬 [Qu'est-ce qu'un module de formation SafeKit ?](<https://youtu.be/ijH4zXtn_3s?t=101s>) (1:57)
  3. 🎬 [Comment obtenir une certification SafeKit ?](<https://youtu.be/ijH4zXtn_3s?t=218s>) (1:40)
  4. 🎬 [Partager votre certification sur LinkedIn](<https://youtu.be/ijH4zXtn_3s?t=318s>) (0:53)

[Plateforme de formation et de certification ici](<https://training.my.evidian.com/>)

### Vidéo SafeKit : Concurrence et architectures de clusters (13:21) {#safekit-competition}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt; 

#### Chapitres

  1. 🎬 [Introduction](<https://youtu.be/DKra6YVLGZk?t=0s>) (4:10)
  2. 🎬 [Cluster de machines virtuelles](<https://youtu.be/DKra6YVLGZk?t=250s>) (1:20)
  3. 🎬 [Cluster miroir (Mirror)](<https://youtu.be/DKra6YVLGZk?t=330s>) (6:04)
  4. 🎬 [Cluster ferme (Farm)](<https://youtu.be/DKra6YVLGZk?t=694s>) (1:46)

[Voir la comparaison SafeKit vs Cluster HA traditionnel](/#safekit-ha-comparison "Comparaison détaillée du logiciel SafeKit par rapport aux clusters HA matériels traditionnels")

### Vidéo SafeKit : Console sur Smartphone (0:42) {#demo-console}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt; 

#### Chapitre

  1. 🎬 [Console sur Smartphone pour la gestion de cluster](<https://youtu.be/W_qaeZmEozAs?t=0s>) (0:42)


### Vidéo SafeKit : Notifications par e-mail lors d'un basculement (0:56) {#demo-notifications}

&amp;amp;amp;amp;amp;amp;lt;br /&amp;amp;amp;amp;amp;amp;gt; 

#### Chapitre

  1. 🎬 [Notifications par e-mail lors d'un basculement](<https://youtu.be/arSUU45_AJs?t=0s>) (0:56)



<!-- END INSERT: insert-safekit-videos-en lang="fr" display="content" -->
 


<!-- BEGIN INSERT: insert-safekit-mirror-en lang="fr" display="content" querystring="app=Windows/Linux" -->
...
Le serveur 1 (PRIM) exécute l'application Windows/Linux. Les clients sont connectés à une [adresse IP virtuelle](</best-practises/how-a-virtual-ip-address-works/>). SafeKit réplique en temps réel via le réseau les modifications apportées à l'intérieur des fichiers.


![Réplication de fichiers au niveau octet dans un cluster miroir Windows/Linux](/wp-content/uploads/2023/02/safekit-prim-second-300.png "w:300")
...
![Basculement de Windows/Linux dans un cluster miroir](/wp-content/uploads/2023/02/safekit-stop-alone-300.png "w:300")
...
![Retour après panne dans un cluster miroir Windows/Linux](/wp-content/uploads/2023/02/safekit-resynchro-alone-300.png "w:300")
...
![Retour au fonctionnement normal dans un cluster miroir Windows/Linux](/wp-content/uploads/2023/02/safekit-second-prim-300.png "w:300")
...
<!-- END INSERT: insert-safekit-mirror-en lang="fr" display="content" querystring="app=Windows/Linux" -->
 


<!-- BEGIN INSERT: insert-safekit-farm-en lang="fr" display="content" querystring="app=Windows/Linux" -->
...
![Comment le cluster SafeKit en mode farm implémente la répartition de charge réseau et le basculement de Windows/Linux](/wp-content/uploads/2023/02/safekit-up-up-up-300.png "w:300")
...
![Console Web SafeKit : Configuration du cluster en mode farm pour la répartition de charge réseau et la gestion de l'IP virtuelle de Windows/Linux.](/wp-content/uploads/2026/01/safekit-farm-cluster-config.png "w:966")
...
![Console SafeKit : Supervision d'un cluster en mode farm à 2 nœuds montrant les deux nœuds de Windows/Linux à l'état UP avec répartition de charge active.](/wp-content/uploads/2026/01/safekit-farm-cluster-monitor.png "w:473")
...
<!-- END INSERT: insert-safekit-farm-en lang="fr" display="content" querystring="app=Windows/Linux" -->
 


<!-- BEGIN INSERT: insert-safekit-differentiators-en lang="fr" display="content" -->
 

## Comparaison de SafeKit avec les clusters de Haute Disponibilité (HA) traditionnels {#safekit-ha-comparison}
...
---|---|---  
Failover Cluster (Microsoft) | Élevée | Stockage spécifique (stockage partagé, SAN)  
...
SafeKit | Faible | Le plus simple, générique et 100 % logiciel. Non adapté à la réplication de gros volumes de données.  
...
## Différences architecturales : SafeKit défini par logiciel vs. Clusters HA Matériels {#ha-arch-diff}
...
## Principaux Éléments Différenciateurs du Cluster Miroir SafeKit {#safemirr-diff}
...
---|---|---  
[3 produits en 1](</fr/best-practises/clustering-software-vs-hardware-clustering/>) | Économise sur Windows et Linux le coût du stockage externe partagé/répliqué, des boîtiers de répartition de charge et des éditions entreprise des OS et bases de données. Inclut toutes les fonctionnalités de clustering : réplication synchrone de fichiers en temps réel, surveillance des pannes, redémarrage automatique, basculement d'adresse IP virtuelle. | Les approches traditionnelles nécessitent des produits séparés pour la réplication du stockage, la répartition de charge et le clustering — augmentant les coûts et la complexité.  
[Configuration très simple](</fr/solutions/>) | Configuration via des modules applicatifs. De nouveaux services et répertoires répliqués peuvent être ajoutés facilement. Le tout géré via une console web centralisée. Aucun contrôleur de domaine ni Active Directory requis. | Microsoft cluster et les solutions similaires nécessitent une configuration complexe d'Active Directory et des contrôleurs de domaine.  
[Réplication synchrone](</fr/best-practises/synchronous-replication-vs-asynchronous-replication/>) | La réplication en temps réel est synchrone sans perte de données en cas de panne (RPO = 0). | La réplication asynchrone peut perdre les transactions récentes non encore répliquées au moment de la panne.  
[Failback entièrement automatisé](</fr/architectures/file-replication-byte-level-with-failover-mirror-cluster/#step3>) | Après une panne, lorsqu'un serveur redémarre, le failback de réplication est entièrement automatique. Le serveur défaillant réintègre le cluster sans arrêter l'application sur le serveur restant. | La plupart des solutions de réplication (notamment au niveau base de données) nécessitent une resynchronisation manuelle. L'application peut même être arrêtée pendant le failback.  
[Réplication de tout type de données](</fr/architectures/file-replication-byte-level-with-failover-mirror-cluster/#step1>) | La réplication fonctionne pour les bases de données et pour tout fichier devant être répliqué. | La réplication au niveau base de données ne protège que la base de données, pas les fichiers de configuration, les journaux ni les autres données applicatives.  
[Réplication de fichiers vs réplication de disque](</fr/best-practises/byte-level-file-replication-vs-block-level-disk-replication/>) | La réplication est basée sur des répertoires de fichiers pouvant être situés n'importe où, même sur le disque système. | La réplication de disque nécessite une partition dédiée et une configuration applicative spéciale pour y stocker les données.  
[Réplication de fichiers vs disque partagé](</fr/best-practises/shared-nothing-architecture-vs-shared-disk-architecture/>) | Les serveurs peuvent être déployés sur deux sites distants sans infrastructure partagée. | Les solutions à disque partagé nécessitent une proximité physique et ne peuvent pas couvrir des sites distants.  
[Sites distants et IP virtuelle](</fr/best-practises/how-a-virtual-ip-address-works/>) | Toutes les fonctionnalités de clustering fonctionnent pour 2 serveurs sur des sites distants. Un LAN étendu permet le reroutage VIP de niveau 2. Pour des réseaux IP différents, la VIP est gérée via un répartiteur de charge avec le health check SafeKit. | De nombreuses solutions de clustering ne prennent pas en charge le basculement entre sites distants ou nécessitent une redirection DNS complexe avec des temps de reprise imprévisibles.  
[Quorum et split brain](</fr/best-practises/heartbeat-failover-quorum-windows-linux-cluster/>) | Fonctionne avec seulement 2 serveurs. Un simple vérificateur de split brain vers un routeur gère l'isolation réseau entre les sites. | La plupart des solutions de clustering nécessitent un 3ème serveur pour la gestion du quorum.  
[Cluster actif/actif](</fr/architectures/active-active-cluster-real-time-replication/>) | Le serveur secondaire n'est pas dédié. Le cluster peut fonctionner en actif/actif avec 2 modules miroir différents. | Les [systèmes tolérants aux pannes](</fr/best-practises/high-availability-cluster-vs-fault-tolerant-system/>) dédient le secondaire à l'exécution de la même application synchronisée au niveau des instructions.  
[Solution HA uniforme](</fr/architectures/clustering-software-load-balancing-mirroring/>) | SafeKit implémente à la fois le cluster miroir (réplication + basculement) et le [cluster farm (répartition de charge + basculement)](</fr/architectures/network-load-balancing-cluster/>). Une architecture N-tiers peut être rendue hautement disponible avec une seule solution sur Windows et Linux. | Les architectures typiques mélangent différentes technologies pour la répartition de charge, la réplication et le basculement — augmentant la complexité opérationnelle.  
[RTO / RPO](</fr/best-practises/what-is-rpo-and-rto-with-examples/>) | Redémarrage rapide de l'application en cas de panne : environ 1 minute ou moins. Aucune perte de données (réplication synchrone). | La [réplication complète de VM](</fr/best-practises/vm-ha-vs-application-ha/>) (VMware HA, Hyper-V cluster) nécessite le redémarrage de l'OS entier sur un nouvel hyperviseur, entraînant des temps de reprise plus longs.  
...
## Principaux Éléments Différenciateurs du Cluster Farm SafeKit {#safefarm-diff}
...
Avantage | Bénéfice détaillé et mécanisme  
---|---  
[Pas de répartiteur de charge, de serveurs proxy dédiés ou d'adresse Ethernet multicast spéciale](</best-practises/how-a-virtual-ip-address-works/>) |  • La solution ne nécessite ni répartiteurs de charge ni serveurs proxy dédiés au-dessus de la ferme pour mettre en œuvre la répartition de charge. SafeKit est installé directement sur les serveurs d'application de la ferme. La répartition de charge repose sur une adresse IP virtuelle standard / adresse MAC Ethernet et fonctionne avec des serveurs physiques ou des machines virtuelles sous Windows et Linux sans configuration réseau particulière<br>• Ce n'est pas le cas avec les répartiteurs de charge réseau<br>• Ce n'est pas le cas avec les proxies dédiés sous Linux<br>• Ce n'est pas le cas avec une [adresse Ethernet multicast spécifique](/best-practises/microsoft-nlb-vmware-multicast-unicast-alternative/) sous Windows   
[Toutes les fonctionnalités de clustering](</architectures/network-load-balancing-cluster/>) |  • La solution inclut toutes les fonctionnalités de clustering : adresse IP virtuelle, répartition de charge sur l'adresse IP du client ou sur les sessions, surveillance des pannes serveur / réseau / logiciel, redémarrage automatique de l'application avec un temps de reprise rapide et une [option de réplication avec un module miroir](/architectures/file-replication-byte-level-with-failover-mirror-cluster/)<br>• Ce n'est pas le cas avec les autres solutions de répartition de charge. Elles sont capables de répartir la charge mais n'incluent pas une solution de clustering complète avec des scripts de redémarrage et un redémarrage automatique de l'application en cas de panne. Elles n'offrent pas d'option de réplication<br>• La configuration du cluster est très simple et se fait au moyen de 💡 [modules applicatifs](/solutions/). Il n'y a pas de contrôleur de domaine ou d'Active Directory à configurer sous Windows. La solution fonctionne sous Windows et Linux   
[Sites distants et adresse IP virtuelle](</best-practises/how-a-virtual-ip-address-works/>) |  • Si les serveurs sont connectés au même réseau IP via un LAN étendu entre sites distants, l'[adresse IP virtuelle](/best-practises/how-a-virtual-ip-address-works/) de SafeKit fonctionne avec la répartition de charge au niveau 2<br>• Si les serveurs sont connectés à des réseaux IP différents entre sites distants, l'adresse IP virtuelle peut être configurée au niveau d'un répartiteur de charge à l'aide du health check SafeKit. Ainsi, vous pouvez mettre en œuvre la répartition de charge mais aussi toutes les fonctionnalités de clustering de SafeKit, en particulier la surveillance et la reprise automatique de l'application critique sur les serveurs d'application   
[Solution de haute disponibilité uniforme](</architectures/clustering-software-load-balancing-mirroring/>) |  • SafeKit implémente un cluster ferme avec répartition de charge et basculement. Mais il implémente également un [cluster miroir avec réplication et basculement](/architectures/file-replication-byte-level-with-failover-mirror-cluster/).<br>• Ainsi, une architecture N-tiers peut être rendue hautement disponible et à charge répartie avec la même solution sous Windows et Linux (même installation, configuration, administration avec la console SafeKit ou avec l'interface en ligne de commande). C'est unique sur le marché<br>• Ce n'est pas le cas avec une architecture mélangeant différentes technologies pour la répartition de charge, la réplication et le basculement   
...
## Haute Disponibilité VM : SafeKit sans SAN vs. Hyper-V/VMware HA {#safe-vmha-diff}
...
Stockage | Pas de disque partagé — [réplication synchrone en temps réel sans perte de données](</fr/best-practises/synchronous-replication-vs-asynchronous-replication/>) | Pas de disque partagé — réplication synchrone des données applicatives uniquement | Nécessite un disque partagé et une baie de disques externe spécifique  
...
À noter que les solutions SafeKit sont les plus simples à mettre en œuvre mais sont **limitées à la réplication de [quelques téraoctets](</fr/#safekit-ha-limitations>) et au basculement de [32 VM](</fr/#safekit-ha-limitations>)**.
...
<!-- END INSERT: insert-safekit-differentiators-en lang="fr" display="content" -->
 


<!-- BEGIN INSERT: insert-safekit-training-en lang="fr" display="content" -->
 

## Ressources, Téléchargements et Documentation sur la Haute Disponibilité SafeKit {#safekit-ha-technical-resources}

💡 Pour démarrer votre parcours de haute disponibilité avec SafeKit, **🛠️[commencez par les Guides d'Installation Rapide](</quick-install/>)**.
...
---|---|---|---  
Toutes plateformes | Document PDF | Bulletin officiel de version (Support OS & Correctifs) | 🛠️ [Voir le SRB SafeKit 8.2](<https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/SafeKit_8.2_Software_Release_Bulletin.pdf> "Bulletin officiel détaillant les OS supportés et les correctifs récents pour SafeKit 8.2.")  
Windows (Intel 64-bit) | Installateur .exe | Inclut Microsoft VC++ Redistributable | ⬇️ [Télécharger SafeKit 8.2 Windows EXE](<https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/safekit_windows_x86_64_8_2_6_5.exe> "Télécharger SafeKit 8.2 pour Windows \(installateur EXE avec VC++ Redistributable\)")  
Windows (Intel 64-bit) | Installateur .msi | _N'inclut pas_ Microsoft VC++ Redistributable | ⬇️ [Télécharger SafeKit 8.2 Windows MSI](<https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/safekit_windows_x86_64_8_2_6_5.msi> "Télécharger SafeKit 8.2 pour Windows \(installateur MSI sans VC++ Redistributable\)")  
Linux (Intel 64-bit) | .BIN auto-extractible | Inclut le package Linux et le script d'installation | ⬇️ [Télécharger SafeKit 8.2 Linux BIN (Intel)](<https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/safekitlinux_x86_64_8_2_6_4.bin> "Télécharger SafeKit 8.2 pour Linux \(fichier BIN auto-extractible avec un package Linux standard et un script d'installation\)")  
Linux (ARM 64-bit) | .BIN auto-extractible | Inclut le package Linux et le script d'installation | ⬇️ [Télécharger SafeKit 8.2 Linux BIN (ARM)](<https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/safekitlinux_aarch64_8_2_5_4.bin> "Télécharger SafeKit 8.2 pour Linux \(fichier BIN auto-extractible avec un package Linux standard et un script d'installation\)")  
...
🔑 [Obtenez Votre Clé d'Essai Gratuite d'1 Mois pour Tester la Haute Disponibilité de SafeKit](<https://safekit.eviden.com/resources/safekit-free-trial-licence-key-high-availability/> "Demandez votre clé de licence d'essai gratuite de 30 jours pour la Haute Disponibilité SafeKit")

### 📚 Guides de configuration SafeKit pour votre cluster HA {#config-guides-heading}

Documentation essentielle pour configurer et gérer votre cluster de Haute Disponibilité SafeKit.  


  * [Guides d'installation rapide SafeKit](</fr/quick-install/> "Démarrez rapidement avec les guides d'installation rapide de SafeKit.")
  * 🛠️ [Guide de l'utilisateur SafeKit en HTML (Version 8.2)](</fr/resources/safekit-user-guide-82/> "Consultez le manuel utilisateur complet de SafeKit version 8.2 \(HTML\).") /🛠️ [Télécharger le PDF](<https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/SafeKit_8.2_Guide_Utilisateur.pdf> "Consultez le manuel utilisateur complet de SafeKit version 8.2 \(PDF\).")
  * 🛠️ [Notes de version SafeKit en HTML (Version 8.2)](</resources/safekit-release-notes-8-2/> "Découvrez les nouveautés, changements et corrections de la version 8.2 de SafeKit \(HTML\).") /🛠️ [Télécharger le PDF](<https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/SafeKit_8.2_Release_Notes.pdf> "Découvrez les nouveautés, changements et corrections de la version 8.2 de SafeKit \(PDF\).")
  * 🛠️ [Bulletin de version logicielle SafeKit 8.2 (SRB)](<https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/SafeKit_8.2_Software_Release_Bulletin.pdf> "Bulletin officiel détaillant les OS pris en charge et les correctifs récents pour SafeKit 8.2.")
  * 🛠️ [Base de connaissances SafeKit](<https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/SafeKit_8.2_Knowledge_Base.pdf> "Base de connaissances SafeKit : conseils de dépannage et réponses aux questions fréquentes.")


### 📞/🤖 Support SafeKit {#support}

  * 📞 [Support payant](</fr/resources/safekit-support/#standard-support>) / 🤖 [Support gratuit](</fr/resources/safekit-support/#ai-support>)
...
Acquérez une expertise précieuse en Haute Disponibilité (HA) grâce à notre programme de certification gratuit.
  ...
  * 🎓 [Obtenez Gratuitement votre Certification SafeKit en Haute Disponibilité](<https://training.my.evidian.com/mod/page/view.php?id=712>)
...
Explorez notre documentation marketing produit pour le logiciel HA SafeKit, qui comprend une fiche technique détaillée, un livre blanc produit et un aperçu technique.
  ...
  * 📘 [Fiche Technique du Cluster de Haute Disponibilité SafeKit (PDF)](</wp-content/uploads/documents/high-availability-overview-fr.pdf>)
  * 📘 [Livre Blanc sur la Technologie de Cluster de Haute Disponibilité (PDF)](</wp-content/uploads/documents/wp-safekit-fr.pdf>)
  * 📘 [Livre blanc – Guide de haute disponibilité (PDF) ](</wp-content/uploads/documents/wp-hadecision-fr.pdf>)
  * 📘 [Référence technique pour la préparation des RFI et RFP](</fr/resources/high-availability-technical-reference-for-rfi-and-rfp-preparation/>)



<!-- END INSERT: insert-safekit-training-en lang="fr" display="content" -->
 


<!-- BEGIN INSERT: insert-safekit-modules-en lang="fr" display="content" -->
...
---|---|---|---  
Nouvelles applications | 💡 [Architecture cluster miroir Windows](</solutions/windows-high-availability-software-synchronous-replication-failover/> "Comment cela fonctionne : réplication en temps réel Windows") | 🛠️ [Guide d’installation rapide pour Windows](</quick-install/safekit-quick-installation-guide-for-a-new-windows-application-with-real-time-replication-and-failover/> "Guide d’installation HA rapide Windows réplication en temps réel \(mirror.safe\)") | 📦 mirror.safe (Windows)*  
Nouvelles applications | 💡 [Architecture cluster miroir Linux](</solutions/linux-high-availability-software-synchronous-replication-failover/> "Comment cela fonctionne : réplication en temps réel Linux") | 🛠️ [Guide d’installation rapide pour Linux](</quick-install/safekit-quick-installation-guide-for-a-new-linux-application-with-real-time-replication-and-failover/> "Guide d’installation HA rapide Linux réplication en temps réel \(mirror.safe\)") | 📦 mirror.safe (Linux)*  
Nouvelles applications | 💡 [Architecture d’équilibrage de charge Windows](</solutions/windows-load-balancing-failover/> "Comment cela fonctionne : équilibrage de charge réseau Windows") | 🛠️ [Guide d’installation rapide pour Windows](</quick-install/safekit-quick-installation-guide-for-a-new-windows-application-with-network-load-balancing-and-failover/> "Guide d’installation HA rapide Windows équilibrage de charge réseau \(farm.safe\)") | 📦 farm.safe (Windows)*  
Nouvelles applications | 💡 [Architecture d’équilibrage de charge Linux](</solutions/linux-load-balancing-failover/> "Comment cela fonctionne : équilibrage de charge réseau Linux") | 🛠️ [Guide d’installation rapide pour Linux](</quick-install/safekit-quick-installation-guide-for-a-new-linux-application-with-network-load-balancing-and-failover/> "Guide d’installation HA rapide Linux équilibrage de charge réseau \(farm.safe\)") | 📦 farm.safe (Linux)*  
Bases de données | 💡 [Architecture cluster miroir Microsoft SQL Server](</solutions/sql-server-high-availability-synchronous-replication-failover/> "Comment cela fonctionne : mirroring SQL Server") | 🛠️ [Guide d’installation rapide pour Microsoft SQL Server](</quick-install/safekit-quick-installation-guide-with-microsoft-sql-server/> "Guide d’installation HA rapide cluster SQL Server") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/sqlserver.safe" download="sqlserver.safe">sqlserver.safe</a> (Windows)  
Bases de données | 💡 [Architecture cluster miroir PostgreSQL](</solutions/postgresql-high-availability-synchronous-replication-failover/> "Comment cela fonctionne : réplication PostgreSQL") | 🛠️ [Guide d’installation rapide pour PostgreSQL](</quick-install/safekit-quick-installation-guide-with-postgresql/> "Guide d’installation HA rapide réplication PostgreSQL") |  📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/postgresql.safe" download="postgresql.safe">postgresql.safe</a> (Windows)<br> 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_linux/postgresql.safe" download="postgresql.safe">postgresql.safe</a> (Linux)   
Bases de données | 💡 [Architecture cluster miroir MySQL](</solutions/mysql-high-availability-synchronous-replication-failover/> "Comment cela fonctionne : cluster MySQL") | 🛠️ [Guide d’installation rapide pour MySQL](</quick-install/safekit-quick-installation-guide-with-mysql/> "Guide d’installation HA rapide cluster MySQL") |  📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/mysql.safe" download="mysql.safe">mysql.safe</a> (Windows)<br> 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_linux/mysql.safe" download="mysql.safe">mysql.safe</a> (Linux)   
Bases de données | 💡 [Architecture cluster miroir MariaDB](</solutions/mariadb-simplest-high-availability-cluster-synchronous-replication-failover-redundant-servers/> "Comment cela fonctionne : cluster MariaDB") | 🛠️ [Guide d’installation rapide pour MariaDB](</quick-install/safekit-quick-installation-guide-with-mariadb/> "Guide d’installation HA rapide cluster MariaDB") |  📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/mysql.safe" download="mysql.safe">mysql.safe</a> (Windows)<br> 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_linux/mysql.safe" download="mysql.safe">mysql.safe</a> (Linux)   
Bases de données | 💡 [Architecture cluster miroir Oracle](</solutions/oracle-high-availability-synchronous-replication-failover/> "Comment cela fonctionne : basculement Oracle") | 🛠️ [Guide d’installation rapide pour Oracle](</quick-install/safekit-quick-installation-guide-with-oracle/> "Guide d’installation HA rapide cluster de basculement Oracle") |  📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/oracle.safe" download="oracle.safe">oracle.safe</a> (Windows)<br> 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_linux/oracle.safe" download="oracle.safe">oracle.safe</a> (Linux)   
Bases de données | 💡 [Architecture cluster miroir Firebird](</solutions/firebird-high-availability-synchronous-replication-failover/> "Comment cela fonctionne : HA Firebird") | 🛠️ [Guide d’installation rapide pour Firebird](</quick-install/safekit-quick-installation-guide-with-firebird/> "Guide d’installation HA rapide Firebird") |  📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/firebird.safe" download="firebird.safe">firebird.safe</a> (Windows)<br> 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_linux/firebird.safe" download="firebird.safe">firebird.safe</a> (Linux)   
Serveurs web | 💡 [Architecture d’équilibrage de charge Apache](</solutions/apache-load-balancing-failover-2/> "Comment cela fonctionne : équilibrage de charge Apache") | 🛠️ [Guide d’installation rapide pour Apache](</quick-install/safekit-quick-installation-guide-with-network-load-balancing-and-failover/> "Guide HA rapide équilibrage de charge et basculement Apache") |  📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/apache_farm.safe" download="apache_farm.safe">apache_farm.safe</a> (Windows)<br> 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_linux/apache_farm.safe" download="apache_farm.safe">apache_farm.safe</a> (Linux)   
Serveurs web | 💡 [Architecture d’équilibrage de charge IIS](</solutions/iis-load-balancing-failover/> "Comment cela fonctionne : équilibrage de charge IIS") | 🛠️ [Guide d’installation rapide pour IIS](</quick-install/safekit-quick-installation-guide-with-iis-with-network-load-balancing-and-failover/> "Guide HA rapide équilibrage de charge et basculement IIS") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/iis_farm.safe" download="iis_farm.safe">iis_farm.safe</a> (Windows)  
Serveurs web | 💡 [Architecture d’équilibrage de charge NGINX](</solutions/nginx-the-simplest-load-balancing-cluster-with-failover/> "Comment cela fonctionne : équilibrage de charge NGINX") | 🛠️ [Guide d’installation rapide pour NGINX](</quick-install/safekit-quick-installation-guide-with-nginx-with-network-load-balancing-and-failover/> "Guide HA rapide équilibrage de charge et basculement NGINX") | 📦 farm.safe (Windows & Linux)*  
VM et conteneurs | 💡 [Architecture HA VM Hyper-V](</solutions/hyper-v-replication-automatic-failover-load-balancing/> "Comment cela fonctionne : réplication Hyper-V") | 🛠️ [Guide d’installation rapide pour Hyper-V](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide d’installation HA rapide réplication VM Hyper-V") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
VM et conteneurs | 💡 [Architecture HA VM KVM](</solutions/linux-kvm-high-availability-replication-automatic-failover-load-balancing/> "Comment cela fonctionne : réplication KVM") | 🛠️ [Guide d’installation rapide pour KVM](</quick-install/safekit-quick-installation-guide-with-kvm/> "Guide d’installation HA rapide réplication VM KVM") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_linux/kvm.safe" download="kvm.safe">kvm.safe</a> (Linux)  
VM et conteneurs | 💡 [Architecture HA conteneur Docker](</solutions/docker-container-high-availability-cluster-synchronous-replication-failover/> "Comment cela fonctionne : basculement Docker") | 🛠️ [Guide d’installation rapide pour Docker](</quick-install/safekit-quick-installation-guide-with-docker/> "Guide HA rapide basculement conteneur Docker") | 📦 mirror.safe (Linux)*  
VM et conteneurs | 💡 [Architecture HA conteneur Podman](</solutions/podman-the-simplest-high-availability-cluster-between-two-redundant-servers/> "Comment cela fonctionne : basculement Podman") | 🛠️ [Guide d’installation rapide pour Podman](</quick-install/safekit-quick-installation-guide-with-podman/> "Guide HA rapide basculement conteneur Podman") | 📦 mirror.safe (Linux)*  
VM et conteneurs | 💡 [Architecture cluster Kubernetes K3S](</solutions/kubernetes-k3s-the-simplest-high-availability-cluster-with-synchronous-replication-and-failover-between-two-redundant-servers/> "Comment cela fonctionne : Kubernetes K3S") | 🛠️ [Guide d’installation rapide pour Kubernetes K3S](</quick-install/safekit-quick-installation-guide-with-kubernetes/> "Guide HA rapide réplication Kubernetes K3S") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_linux/k3s.safe" download="k3s.safe">k3s.safe</a> (Linux)  
Cloud AWS | 💡 [Architecture cluster miroir AWS](</solutions/aws-high-availability-cluster-synchronous-replication-failover/> "Comment cela fonctionne : cluster de réplication AWS") | 🛠️ [Guide d’installation rapide pour AWS](</quick-install/safekit-quick-installation-guide-in-aws-mirror-safe-module-for-real-time-replication-and-failover/> "Guide HA rapide cluster de réplication AWS \(mirror.safe\)") | 📦 mirror.safe (Windows & Linux)*  
Cloud AWS | 💡 [Architecture d’équilibrage de charge AWS](</solutions/aws-load-balancing-cluster-failover/> "Comment cela fonctionne : équilibrage de charge AWS") | 🛠️ [Guide d’installation rapide pour AWS](</quick-install/safekit-quick-installation-guide-in-aws-with-network-load-balancing-and-failover/> "Guide HA rapide cluster d’équilibrage AWS \(farm.safe\)") | 📦 farm.safe (Windows & Linux)*  
Cloud GCP | 💡 [Architecture cluster miroir GCP](</solutions/gcp-high-availability-cluster-synchronous-replication-failover/> "Comment cela fonctionne : cluster de réplication GCP") | 🛠️ [Guide d’installation rapide pour GCP](</quick-install/safekit-quick-installation-guide-in-gcp-with-real-time-replication-and-failover/> "Guide HA rapide cluster de réplication GCP \(mirror.safe\)") | 📦 mirror.safe (Windows & Linux)*  
Cloud GCP | 💡 [Architecture d’équilibrage de charge GCP](</solutions/gcp-load-balancing-cluster-failover/> "Comment cela fonctionne : équilibrage de charge GCP") | 🛠️ [Guide d’installation rapide pour GCP](</quick-install/safekit-quick-installation-guide-in-gcp-with-network-load-balancing-and-failover/> "Guide HA rapide cluster d’équilibrage GCP \(farm.safe\)") | 📦 farm.safe (Windows & Linux)*  
Cloud Azure | 💡 [Architecture cluster miroir Azure](</solutions/azure-high-availability-cluster-synchronous-replication-failover/> "Comment cela fonctionne : cluster de réplication Azure") | 🛠️ [Guide d’installation rapide pour Azure](</quick-install/safekit-quick-installation-guide-in-azure-with-real-time-replication-and-failover/> "Guide HA rapide cluster de réplication Azure \(mirror.safe\)") | 📦 mirror.safe (Windows & Linux)*  
Cloud Azure | 💡 [Architecture d’équilibrage de charge Azure](</solutions/azure-load-balancing-cluster-failover/> "Comment cela fonctionne : équilibrage de charge Azure") | 🛠️ [Guide d’installation rapide pour Azure](</quick-install/safekit-quick-installation-guide-in-azure-with-network-load-balancing-and-failover/> "Guide HA rapide cluster d’équilibrage Azure \(farm.safe\)") | 📦 farm.safe (Windows & Linux)*  
Cloud | 💡 [Architecture cluster miroir cloud](</solutions/cloud-high-availability-cluster-synchronous-replication-failover/> "Comment cela fonctionne : cluster de réplication cloud") | 🛠️ [Guide d’installation rapide pour le cloud](</quick-install/safekit-quick-installation-guide-in-cloud-with-real-time-replication-and-failover/> "Guide HA rapide cluster de réplication cloud \(mirror.safe\)") | 📦 mirror.safe (Windows & Linux)*  
Cloud | 💡 [Architecture d’équilibrage de charge cloud](</solutions/cloud-load-balancing-cluster-failover/> "Comment cela fonctionne : équilibrage de charge cloud") | 🛠️ [Guide d’installation rapide pour le cloud](</quick-install/safekit-quick-installation-guide-in-cloud-with-network-load-balancing-and-failover/> "Guide HA rapide cluster d’équilibrage cloud \(farm.safe\)") | 📦 farm.safe (Windows & Linux)*  
Sécurité physique / VMS | 💡 [Architecture cluster miroir Milestone XProtect](</solutions/milestone-xprotect-corporate-high-availability-synchronous-replication-failover/> "Comment cela fonctionne : basculement Milestone XProtect") | 🛠️ [Guide d’installation rapide pour Milestone XProtect](</quick-install/safekit-quick-installation-guide-with-milestone-xprotect-management-server/> "Guide HA rapide basculement serveur de gestion Milestone XProtect") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/milestone.safe" download="milestone.safe">milestone.safe</a> (Windows)  
Sécurité physique / VMS | 💡 [Architecture cluster miroir Nedap AEOS](</solutions/nedap-high-availability-synchronous-replication-failover/> "Comment cela fonctionne : basculement Nedap AEOS") | 🛠️ [Guide d’installation rapide pour Nedap AEOS](</quick-install/safekit-quick-installation-guide-with-nedap/> "Guide HA rapide basculement Nedap AEOS") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/nedap.safe" download="nedap.safe">nedap.safe</a> (Windows)  
Sécurité physique / VMS | 💡 [Architecture cluster miroir SQL Genetec](</solutions/sql-server-high-availability-synchronous-replication-failover/> "Comment cela fonctionne : basculement SQL Genetec") | 🛠️ [Guide d’installation rapide pour Genetec (SQL Server)](</quick-install/safekit-quick-installation-guide-with-microsoft-sql-server/> "Guide HA rapide basculement SQL Server Genetec") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/sqlserver.safe" download="sqlserver.safe">sqlserver.safe</a> (Windows)  
Sécurité physique / VMS | 💡 [Architecture HA VM Bosch AMS](</solutions/bosch-ams-the-simplest-high-availability-cluster-between-two-redundant-servers-without-shared-disk/> "Comment cela fonctionne : HA Bosch AMS") | 🛠️ [Guide d’installation rapide pour Bosch AMS](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Bosch AMS") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
Sécurité physique / VMS | 💡 [Architecture HA VM Bosch BIS](</solutions/bosch-bis-the-simplest-high-availability-cluster-between-two-redundant-servers-without-shared-disk/> "Comment cela fonctionne : HA Bosch BIS") | 🛠️ [Guide d’installation rapide pour Bosch BIS](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Bosch BIS") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
Sécurité physique / VMS | 💡 [Architecture HA VM Bosch BVMS](</solutions/bosch-bvms-the-simplest-high-availability-cluster-between-two-redundant-servers-without-shared-disk/> "Comment cela fonctionne : HA Bosch BVMS") | 🛠️ [Guide d’installation rapide pour Bosch BVMS](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Bosch BVMS") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
Sécurité physique / VMS | 💡 [Architecture HA VM Hanwha Vision](</solutions/hanwha-vision-cluster-without-shared-storage-on-a-san/> "Comment cela fonctionne : HA Hanwha Vision") | 🛠️ [Guide d’installation rapide pour Hanwha Vision](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Hanwha Vision") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
Sécurité physique / VMS | 💡 [Architecture HA VM Hanwha Wisenet](</solutions/hanwha-wisenet-wave-the-simplest-high-availability-cluster-between-two-redundant-servers-without-shared-disk/> "Comment cela fonctionne : HA Hanwha Wisenet") | 🛠️ [Guide d’installation rapide pour Hanwha Wisenet](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Hanwha Wisenet") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
Produits Siemens | 💡 [Architecture HA VM Siemens Siveillance](</solutions/siemens-siveillance-redundancy-high-availability-cluster-active-active/> "Comment cela fonctionne : HA Siemens Siveillance suite") | 🛠️ [Guide d’installation rapide pour Siemens Siveillance suite](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Siemens Siveillance suite") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
Produits Siemens | 💡 [Architecture HA VM Siemens Desigo CC](</solutions/siemens-desigo-cc-redundancy-high-availability-cluster-active-active/> "Comment cela fonctionne : HA Siemens Desigo CC") | 🛠️ [Guide d’installation rapide pour Siemens Desigo CC](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Siemens Desigo CC") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
...
Produits Siemens | 💡 [Architecture HA VM Siemens SiPass](</solutions/siemens-sipass-redundancy-high-availability-cluster-active-active/> "Comment cela fonctionne : HA Siemens SiPass") | 🛠️ [Guide d’installation rapide pour Siemens SiPass](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Siemens SiPass") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
Produits Siemens | 💡 [Architecture HA VM Siemens SIPORT](</solutions/siemens-siport-redundancy-high-availability-cluster-active-active/> "Comment cela fonctionne : HA Siemens SIPORT") | 🛠️ [Guide d’installation rapide pour Siemens SIPORT](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Siemens SIPORT") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
Produits Siemens | 💡 [Architecture HA VM SIMATIC PCS 7](</solutions/siemens-simatic-pcs-7-redundancy-high-availability-cluster-active-active/> "Comment cela fonctionne : HA Siemens SIMATIC PCS 7") | 🛠️ [Guide d’installation rapide pour Siemens SIMATIC PCS 7](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Siemens SIMATIC PCS 7") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
Produits Siemens | 💡 [Architecture HA VM SIMATIC WinCC](</solutions/siemens-simatic-wincc-redundancy-high-availability-cluster-active-active/> "Comment cela fonctionne : HA Siemens SIMATIC WinCC") | 🛠️ [Guide d’installation rapide pour Siemens SIMATIC WinCC](</quick-install/safekit-quick-installation-guide-with-hyper-v/> "Guide HA rapide basculement Hyper-V Siemens SIMATIC WinCC") | 📦 <a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/hyperv.safe" download="hyperv.safe">hyperv.safe</a> (Windows)  
  

<!-- END INSERT: insert-safekit-modules-en lang="fr" display="content" -->
