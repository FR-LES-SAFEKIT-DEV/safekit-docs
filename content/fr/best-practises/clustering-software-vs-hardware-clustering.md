...
<img src="/safekit-docs/wp-content/uploads/2023/03/high-availability-architectures-and-best-practices.png" width="400" alt="Cluster logiciel vs cluster matériel">
...
Le cluster logiciel pour un backend (comme avec [SafeKit](</safekit-docs/fr/>)) est basé sur 2 serveurs répliquant en temps réel des données avec un basculement automatique des applications en cas de panne.
...
Critère | Clustering logiciel [SafeKit](</safekit-docs/fr/>) | Clustering matériel | Répartiteurs de charge matériels  
---|---|---|---  
