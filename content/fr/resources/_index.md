---
title: "Ressources SafeKit - SafeKit HA"
canonical: "https://safekit.eviden.com/fr/resources/"
description: "Téléchargez l'essai gratuit de SafeKit, accédez à la documentation technique, aux guides d'installation rapide, aux guides d'utilisation, aux livres blancs et aux ressources produit pour le clustering haute disponibilité sous Windows et Linux."
category: "resources"
lang: "fr"
...
---|---|---  
• [Essai gratuit de SafeKit](/resources/safekit-free-trial/)<br>• [Clé de licence d'un mois](/resources/high-availability-and-load-balancing-cluster-key/)<br>• [Démonstrations](/resources/high-availability-solutions-ha-solutions-videos/)<br>• [Support](/resources/safekit-support/)<br>• [Formation gratuite et certification](/resources/safekit-on-line-training/)  |  • 🛠️ [Guides d'installation rapide SafeKit](/quick-install/)<br>• 🛠️ [Guide de l'utilisateur SafeKit](/resources/safekit-user-guide-82/)<br>• 🛠️ [Notes de version SafeKit](/resources/safekit-release-notes-8-2/)<br>• 🛠️ [SRB SafeKit](https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/SafeKit_8.2_Software_Release_Bulletin.pdf)<br>• 🛠️ [Base de connaissances](https://github.com/FR-LES-SAFEKIT-DEV/safekit-packages/releases/download/v8.2/SafeKit_8.2_Knowledge_Base.pdf)  |  • 📘 [Fiche produit](/wp-content/uploads/documents/high-availability-overview-fr.pdf)<br>• 📘 [Livre blanc - Produit](/wp-content/uploads/documents/wp-safekit-fr.pdf)<br>• 📘 [Livre blanc - Guide de haute disponibilité](/wp-content/uploads/documents/wp-hadecision-fr.pdf)<br>• 📘 [Référence technique pour préparation d'RFI et RFP](/resources/high-availability-technical-reference-for-rfi-and-rfp-preparation/)   
