...
# Haute disponibilité et redondance pour les logiciels de contrôle d'accès électronique (EACS)

##  Qu'est-ce qu'un système de contrôle d'accès (EACS) ? 

Les systèmes de contrôle d'accès électroniques consistent en des dispositifs matériels qui contrôlent l'entrée dans tous les locaux privés.

Les vols et les effractions sont des délits courants dans les environnements professionnels. Les systèmes de contrôle d'accès électroniques sont largement utilisés à cause de cela.

##  Pourquoi un logiciel EACS est critique ? 

Le logiciel EACS gère les périphériques matériels, et il refuse l'entrée aux utilisateurs non autorisés et lève des alarmes sur intrusion de voleurs ou de criminels.

La sécurité des personnes est directement associée à la bonne exécution du logiciel EACS.
...
##  Liste des acteurs clés sur le marché EACS 

Les principaux acteurs sur le marché de l'EACS sont :
...
<!-- BEGIN INSERT: insert-safekit-security-solutions-fr lang="fr" display="content" querystring="app=EACS" -->
 

## SafeKit apporte deux solutions pour la redondance et la haute disponibilité des logiciels EACS 
...
<img src="/safekit-docs/wp-content/uploads/2023/02/application-ha-4.png" width="168" alt="Redondance au niveau applicatif pour un logiciel EACS">
...
Dans ce type de solution, le logiciel EACS est placé dans une machine virtuelle. La machine virtuelle (VM) complète est répliquée et redémarrée (Application + OS).


<img src="/safekit-docs/wp-content/uploads/2023/02/vm-ha-4.png" width="184" alt="Redondance au niveau machine virtuelle pour un logiciel EACS">


L'avantage de cette solution est qu'elle ne nécessite pas une compréhension technique de l'application; vous devez seulement définir l'emplacement des fichiers de la VM où l'application est installée. Cette solution est générique pour tous les logiciels EACS. Cependant, elle fonctionne avec les hyperviseurs Windows/Hyper-V et Linux/KVM mais pas avec VMware. Il s'agit d'une solution active/active avec plusieurs machines virtuelles répliquées et redémarrées entre deux nœuds.
...
<!-- END INSERT: insert-safekit-security-solutions-fr lang="fr" display="content" querystring="app=EACS" -->
 


<!-- BEGIN INSERT: insert-safekit-security-case-fr lang="fr" display="content" querystring="app=EACS" -->
...
<!-- END INSERT: insert-safekit-security-case-fr lang="fr" display="content" querystring="app=EACS" -->
