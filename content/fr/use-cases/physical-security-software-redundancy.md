---
title: "Haute disponibilité et redondance pour les logiciels de sécurité physique"
slug: "physical-security-software-redundancy"
canonical: "https://safekit.eviden.com/fr/use-cases/physical-security-software-redundancy/"
description: "Haute disponibilité et redondance pour les logiciels de sécurité physique"
category: "use-cases"
lang: "fr"
topics: "SafeKit apporte deux solutions pour la redondance et la haute disponibilité des logiciels de sécurité physique, SafeKit, une solution reconnue sur le marché de la sécurité, 🔍 Hub de navigation SafeKit Haute Disponibilité"
---

# Haute disponibilité et redondance pour les logiciels de sécurité physique


<!-- BEGIN INSERT: insert-safekit-security-solutions-fr lang="fr" display="content" querystring="app=de sécurité physique" -->
 

## SafeKit apporte deux solutions pour la redondance et la haute disponibilité des logiciels de sécurité physique 
...
<img src="/safekit-docs/wp-content/uploads/2023/02/application-ha-4.png" width="168" alt="Redondance au niveau applicatif pour un logiciel de sécurité physique">
...
Dans ce type de solution, le logiciel de sécurité physique est placé dans une machine virtuelle. La machine virtuelle (VM) complète est répliquée et redémarrée (Application + OS).


<img src="/safekit-docs/wp-content/uploads/2023/02/vm-ha-4.png" width="184" alt="Redondance au niveau machine virtuelle pour un logiciel de sécurité physique">


L'avantage de cette solution est qu'elle ne nécessite pas une compréhension technique de l'application; vous devez seulement définir l'emplacement des fichiers de la VM où l'application est installée. Cette solution est générique pour tous les logiciels de sécurité physique. Cependant, elle fonctionne avec les hyperviseurs Windows/Hyper-V et Linux/KVM mais pas avec VMware. Il s'agit d'une solution active/active avec plusieurs machines virtuelles répliquées et redémarrées entre deux nœuds.
...
<!-- END INSERT: insert-safekit-security-solutions-fr lang="fr" display="content" querystring="app=de sécurité physique" -->
 


<!-- BEGIN INSERT: insert-safekit-security-case-fr lang="fr" display="content" querystring="app=de sécurité physique" -->
...
<!-- END INSERT: insert-safekit-security-case-fr lang="fr" display="content" querystring="app=de sécurité physique" -->
