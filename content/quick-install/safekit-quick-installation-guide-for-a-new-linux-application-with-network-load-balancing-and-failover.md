...
<!-- BEGIN INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=Linux&amp;mod=farm" -->
 

## High Availability Quick Installation Guide for Linux {#quick-guide}

This guide explains how to set up a **farm cluster** for Linux using SafeKit, ensuring network load balancing and automatic failover.
...
### 3\. Configuration
  ...
  * **Web Console:** Configure the Linux farm cluster.
...
<!-- END INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=Linux&amp;mod=farm" -->
 

## Overview of the SafeKit / Linux solution

The solution is described here: **[SafeKit: All-in-One Linux Load Balancing& High Availability Software](</safekit-docs/solutions/linux-load-balancing-failover/>)**.
...
<!-- BEGIN INSERT: insert-safekit-installation-package-linux-en lang="en" display="content" querystring="app=&amp;mod=farm&amp;farm" -->
...
<!-- END INSERT: insert-safekit-installation-package-linux-en lang="en" display="content" querystring="app=&amp;mod=farm&amp;farm" -->
...
<!-- BEGIN INSERT: insert-safekit-82-farm-configuration-en lang="en" display="content" querystring="app=Linux&amp;mod=farm" -->
 

### Prerequisites

  * Linux application installed on 2 nodes (or more).
...
<img src="/safekit-docs/wp-content/uploads/2025/05/36-module-farm-config-edit-1.jpg" alt="Enter the Linux farm module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/35-module-iis-edit-script-1.png" alt="Enter the Linux module settings">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/11-monitoring-farm-stop-stop-start.png" alt="Start the Linux cluster on both nodes">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/15-monitoring-up-up.png" alt="The Linux cluster is started">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/appli-19.png" alt="Test the virtual IP address of Linux with the mosaic">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/32-snapshots-farm.png" alt="Take the Linux snaphots for support">



<!-- END INSERT: insert-safekit-82-farm-configuration-en lang="en" display="content" querystring="app=Linux&amp;mod=farm" -->
