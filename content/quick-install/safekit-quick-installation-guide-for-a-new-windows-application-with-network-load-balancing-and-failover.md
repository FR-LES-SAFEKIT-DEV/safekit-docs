...
lang: "en"
topics: "High Availability Quick Installation Guide for Windows, SafeKit High Availability Limitations, Overview of the SafeKit / Windows solution, Installation of the SafeKit / Windows solution (farm.safe), Step by step configuration of the SafeKit / Windows solution, Demonstration of the SafeKit farm solution, 🔍 SafeKit High Availability Navigation Hub"
---

# Windows Network Load Balancing & Failover: Install the SafeKit farm.safe Module


<!-- BEGIN INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=Windows&amp;mod=farm" -->
 

## High Availability Quick Installation Guide for Windows {#quick-guide}

This guide explains how to set up a **farm cluster** for Windows using SafeKit, ensuring network load balancing and automatic failover.
...
### 3\. Configuration
  ...
  * **Web Console:** Configure the Windows farm cluster.
...
<!-- END INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=Windows&amp;mod=farm" -->
 

## Overview of the SafeKit / Windows solution

The solution is described here: **[SafeKit: All-in-One Windows Load Balancing& High Availability Software](</safekit-docs/solutions/windows-load-balancing-failover/>)**.

## Installation of the SafeKit / Windows solution (farm.safe)

### Prerequisites

  * You need the application that you want to put in a farm installed on 2 nodes or more (virtual machines or physical servers).



<!-- BEGIN INSERT: insert-safekit-installation-package-windows-en lang="en" display="content" querystring="app=&amp;mod=farm&amp;farm" -->
...
<!-- END INSERT: insert-safekit-installation-package-windows-en lang="en" display="content" querystring="app=&amp;mod=farm&amp;farm" -->
...
<!-- BEGIN INSERT: insert-safekit-82-farm-configuration-en lang="en" display="content" querystring="app=Windows&amp;mod=farm" -->
 

### Prerequisites

  * Windows application installed on 2 nodes (or more).
...
<img src="/safekit-docs/wp-content/uploads/2025/05/36-module-farm-config-edit-1.jpg" alt="Enter the Windows farm module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/35-module-iis-edit-script-1.png" alt="Enter the Windows module settings">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/11-monitoring-farm-stop-stop-start.png" alt="Start the Windows cluster on both nodes">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/15-monitoring-up-up.png" alt="The Windows cluster is started">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/appli-19.png" alt="Test the virtual IP address of Windows with the mosaic">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/32-snapshots-farm.png" alt="Take the Windows snaphots for support">



<!-- END INSERT: insert-safekit-82-farm-configuration-en lang="en" display="content" querystring="app=Windows&amp;mod=farm" -->
