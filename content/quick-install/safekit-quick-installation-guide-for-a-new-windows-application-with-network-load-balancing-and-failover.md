...
{{%  insert-safekit-farm-guide-en app="Windows" mod="farm" %}}
...
{{%  insert-safekit-installation-package-windows-en mod="farm" %}}
...
{{%  insert-safekit-82-farm-configuration-en app="Windows" mod="farm" %}}
