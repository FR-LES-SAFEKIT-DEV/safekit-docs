...
slug: "safekit-quick-installation-guide-in-azure-with-network-load-balancing-and-failover"
...
lang: "en"
topics: "High Availability Quick Installation Guide for Azure, SafeKit High Availability Limitations, Overview of the SafeKit / Azure solution, Installation of the SafeKit / Azure solution on Windows and Linux (farm.safe), Step by step configuration of the SafeKit / Azure solution, Demonstration of the SafeKit farm solution, 🔍 SafeKit High Availability Navigation Hub"
---

# Azure Network Load Balancing & Failover: Install the SafeKit farm.safe Module


<!-- BEGIN INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=Azure&amp;mod=farm" -->
 

## High Availability Quick Installation Guide for Azure {#quick-guide}

This guide explains how to set up a **farm cluster** for Azure using SafeKit, ensuring network load balancing and automatic failover.
...
### 3\. Configuration
  ...
  * **Web Console:** Configure the Azure farm cluster.
...
<!-- END INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=Azure&amp;mod=farm" -->
 

## Overview of the SafeKit / Azure solution

The solution is described here: **[SafeKit: Microsoft Azure Load Balancing& Application High Availability Farm Cluster](</safekit-docs/solutions/azure-load-balancing-cluster-failover/>)**.

## Installation of the SafeKit / Azure solution on Windows and Linux (farm.safe)
