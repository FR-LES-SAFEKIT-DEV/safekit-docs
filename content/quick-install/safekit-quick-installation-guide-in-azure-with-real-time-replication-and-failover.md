...
<!-- BEGIN INSERT: insert-safekit-mirror-guide-en lang="en" display="content" querystring="app=Azure&amp;mod=mirror" -->
 

## High Availability Quick Installation Guide for Azure {#quick-guide}

This guide explains how to set up a **mirror cluster** for Azure using SafeKit, ensuring automatic failover and synchronous replication without the need for shared storage. 
...
### 3\. Configuration
  ...
  * **Web Console:** Configure the specific folders containing the Azure files.
  * **Monitoring:** Start monitoring and protecting the Azure application.
...
<!-- END INSERT: insert-safekit-mirror-guide-en lang="en" display="content" querystring="app=Azure&amp;mod=mirror" -->
 

## Overview of the SafeKit / Azure mirror solution

The solution is described here: **[Microsoft Azure High Availability: SafeKit Synchronous Replication& Failover](</safekit-docs/solutions/azure-high-availability-cluster-synchronous-replication-failover/>)**.
