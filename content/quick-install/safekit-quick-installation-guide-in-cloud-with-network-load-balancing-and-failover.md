...
<!-- BEGIN INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=Cloud&amp;mod=farm" -->
...
### 3\. Configuration
  ...
  * **Web Console:** Configure the Cloud farm cluster.
...
<!-- END INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=Cloud&amp;mod=farm" -->
