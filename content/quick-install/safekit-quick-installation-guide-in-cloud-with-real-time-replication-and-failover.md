---
title: "Cloud High Availability with SafeKit: Install the mirror.safe Module for Failover"
slug: "safekit-quick-installation-guide-in-cloud-with-real-time-replication-and-failover"
canonical: "https://safekit.eviden.com/quick-install/safekit-quick-installation-guide-in-cloud-with-real-time-replication-and-failover/"
...
lang: "en"
topics: "High Availability Quick Installation Guide for Cloud, SafeKit High Availability Limitations, Overview of the SafeKit / Cloud mirror solution, Installation of the SafeKit / Cloud mirror solution on Windows and Linux (mirror.safe), Step by step configuration of the SafeKit / Cloud mirror solution, Demonstration of the SafeKit mirror solution, 🔍 SafeKit High Availability Navigation Hub"
---

# Cloud High Availability with SafeKit: Install the mirror.safe Module for Failover


<!-- BEGIN INSERT: insert-safekit-mirror-guide-en lang="en" display="content" querystring="app=Cloud&amp;mod=mirror" -->
 

## High Availability Quick Installation Guide for Cloud {#quick-guide}

This guide explains how to set up a **mirror cluster** for Cloud using SafeKit, ensuring automatic failover and synchronous replication without the need for shared storage. 
...
### 3\. Configuration
  ...
  * **Web Console:** Configure the specific folders containing the Cloud files.
  * **Monitoring:** Start monitoring and protecting the Cloud application.
...
<!-- END INSERT: insert-safekit-mirror-guide-en lang="en" display="content" querystring="app=Cloud&amp;mod=mirror" -->
 

## Overview of the SafeKit / Cloud mirror solution

The solution is described here: **[Cloud-Agnostic High Availability: SafeKit Synchronous Replication& Failover](</safekit-docs/solutions/cloud-high-availability-cluster-synchronous-replication-failover/>)**.

## Installation of the SafeKit / Cloud mirror solution on Windows and Linux (mirror.safe)
...
<div class="callout callout-warning"><img src="/safekit-docs/wp-content/uploads/2022/07/warning-small.png" alt="Warning"><span>Do not configure a virtual IP address at step 4 in the step by step configuration below. The virtual IP address is already set in the Cloud load balancer. Setting a virtual IP at step 4 is useful for on-premise configuration only.</span></div>
...
## Step by step configuration of the SafeKit / Cloud mirror solution


<!-- BEGIN INSERT: insert-safekit-82-configuration-en lang="en" display="content" querystring="app=Windows&amp;mod=mirror" -->
 

### Prerequisites

  * Windows application installed on 2 nodes.
...
<img src="/safekit-docs/wp-content/uploads/2024/03/01-login-large.png" alt="Start the SafeKit web console to configure the Windows cluster">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/02-cluster-edit.png" alt="Enter the nodes of the Windows cluster">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/04-module-new.png" alt="Choose the module for Windows">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/05-module-mirror-edit-config-3.png" alt="Enter the Windows module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/28-module-sqlserver-edit-script-3.png" alt="Enter the Windows module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/07-module-encryption-1.png" alt="Communication encryption of the Windows module">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/08-module-save-1.png" alt="Save and apply the Windows module configuration">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/09-module-save-check-1.png" alt="Check the Windows module configuration success">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/10-monitoring-mirror-stop-stop-prim.png" alt="Start as primary the Windows node with the up-to-date data">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/12-monitoring-alone-stop.png" alt="The first Windows node starts as primary and becomes ALONE">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/13-monitoring-alone-stop-start.png" alt="Start the Windows node 2">


### 12\. Verify that the cluster is operational

  * Check that the cluster is green/green with Windows services running on the PRIM node and not running on the SECOND node.


Only changes inside files are replicated in real time in this state.


<div class="callout callout-warning"><img src="/safekit-docs/wp-content/uploads/2022/07/warning-small.png" alt="Warning"><span>Components that are clients of Windows services must be configured with the virtual IP address. The configuration can be done with a DNS name (if a DNS name has been created and associated with the virtual IP address).</span></div>


<img src="/safekit-docs/wp-content/uploads/2024/03/14-monitoring-prim-second.png" alt="The Windows node 2 is SECOND (green)">
...
### 13\. Testing
  ...
  * And with Microsoft Management Console (MMC) on Windows or with command lines on Linux, check the failover of Windows services (stopped on node 1 in the `stop_prim` script and started on node 2 in the `start_prim` script).
...
<img src="/safekit-docs/wp-content/uploads/2024/03/16-monitoring-prim-second-stop.png" alt="Stop the Windows module on the PRIM server">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/30-snapshots-mirror.png" alt="Take the Windows snaphots for support">



<!-- END INSERT: insert-safekit-82-configuration-en lang="en" display="content" querystring="app=Windows&amp;mod=mirror" -->
