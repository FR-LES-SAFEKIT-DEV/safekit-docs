...
<!-- BEGIN INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=GCP&amp;mod=farm" -->
 

## High Availability Quick Installation Guide for GCP {#quick-guide}

This guide explains how to set up a **farm cluster** for GCP using SafeKit, ensuring network load balancing and automatic failover.
...
### 3\. Configuration
  ...
  * **Web Console:** Configure the GCP farm cluster.
...
<!-- END INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=GCP&amp;mod=farm" -->
 

## Overview of the SafeKit / GCP solution

The solution is described here: **[SafeKit: Google GCP Load Balancing& Application High Availability Farm Cluster](</safekit-docs/solutions/gcp-load-balancing-cluster-failover/>)**.
