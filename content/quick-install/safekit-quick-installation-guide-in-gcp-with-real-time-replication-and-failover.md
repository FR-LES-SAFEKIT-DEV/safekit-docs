...
# GCP High Availability with SafeKit: Install the mirror.safe Module for Failover


<!-- BEGIN INSERT: insert-safekit-mirror-guide-en lang="en" display="content" querystring="app=GCP&amp;mod=mirror" -->
 

## High Availability Quick Installation Guide for GCP {#quick-guide}

This guide explains how to set up a **mirror cluster** for GCP using SafeKit, ensuring automatic failover and synchronous replication without the need for shared storage. 
...
### 3\. Configuration
  ...
  * **Web Console:** Configure the specific folders containing the GCP files.
  * **Monitoring:** Start monitoring and protecting the GCP application.
...
<!-- END INSERT: insert-safekit-mirror-guide-en lang="en" display="content" querystring="app=GCP&amp;mod=mirror" -->
 

## Overview of the SafeKit / GCP mirror solution

The solution is described here: **[Google GCP High Availability: SafeKit Synchronous Replication& Failover](</safekit-docs/solutions/gcp-high-availability-cluster-synchronous-replication-failover/>)**.
...
## Step by step configuration of the SafeKit / GCP mirror solution
