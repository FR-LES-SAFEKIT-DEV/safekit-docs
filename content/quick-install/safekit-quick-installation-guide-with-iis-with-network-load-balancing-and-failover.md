---
title: "IIS Network Load Balancing & Failover: Install the SafeKit iis_farm.safe Module"
slug: "safekit-quick-installation-guide-with-iis-with-network-load-balancing-and-failover"
canonical: "https://safekit.eviden.com/quick-install/safekit-quick-installation-guide-with-iis-with-network-load-balancing-and-failover/"
...
lang: "en"
topics: "High Availability Quick Installation Guide for IIS, SafeKit High Availability Limitations, Overview of the SafeKit / IIS solution, Installation of the SafeKit / IIS solution on Windows (iis_farm.safe), Step by step configuration of the SafeKit / IIS solution, Demonstration of the SafeKit farm solution, 🔍 SafeKit High Availability Navigation Hub"
---

# IIS Network Load Balancing & Failover: Install the SafeKit iis_farm.safe Module


<!-- BEGIN INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=IIS&amp;mod=iis_farm" -->
 

## High Availability Quick Installation Guide for IIS {#quick-guide}

This guide explains how to set up a **farm cluster** for IIS using SafeKit, ensuring network load balancing and automatic failover.
...
### 2\. Installation
  ...
  * **Module:** Download the pre-configured `iis_farm.safe` application module.


### 3\. Configuration

  * **Web Console:** Configure the IIS farm cluster.
  * **Monitoring:** Start monitoring and protecting the IIS application.
...
<!-- END INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=IIS&amp;mod=iis_farm" -->
 

## Overview of the SafeKit / IIS solution

The solution is described here: **[SafeKit: All-in-One IIS Load Balancing& High Availability Software](</safekit-docs/solutions/iis-load-balancing-failover/>)**.

## Installation of the SafeKit / IIS solution on Windows (iis_farm.safe)

### Prerequisites

  * You need IIS installed on 2 nodes or more (virtual machines or physical servers).



<!-- BEGIN INSERT: insert-safekit-installation-package-windows-en lang="en" display="content" querystring="app=IIS&amp;mod=iis_farm&amp;farm" -->
...
<!-- END INSERT: insert-safekit-installation-package-windows-en lang="en" display="content" querystring="app=IIS&amp;mod=iis_farm&amp;farm" -->
 


<!-- BEGIN INSERT: insert-safekit-82-installation-module-windows-en lang="en" display="content" querystring="app=IIS&amp;mod=iis_farm&amp;farm" -->
 

### Module installation on Windows

  * Download the iis_farm.safe module. The module is free. It contains the files userconfig.xml and the restart scripts.
  * Put **iis_farm.safe** under **C:/safekit/Application_Modules/generic**.


<a class="btn-download" href="/safekit-docs/wp-content/uploads/downloads_safekit/version-82/modules_windows/iis_farm.safe" download="iis_farm.safe">⬇️ Download iis_farm.safe (Windows) ></a> 


<!-- END INSERT: insert-safekit-82-installation-module-windows-en lang="en" display="content" querystring="app=IIS&amp;mod=iis_farm&amp;farm" -->
 

## Step by step configuration of the SafeKit / IIS solution


<!-- BEGIN INSERT: insert-safekit-82-farm-configuration-en lang="en" display="content" querystring="app=IIS&amp;mod=iis_farm" -->
 

### Prerequisites

  * IIS application installed on 2 nodes (or more).
...
<img src="/safekit-docs/wp-content/uploads/2024/03/01-login-large.png" alt="Start the SafeKit web console to configure the IIS cluster">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/02-cluster-edit.png" alt="Enter the nodes of the IIS cluster">


### 3\. Select a module

  * In `New module`, click on the `iis_farm.safe` module.
...
<img src="/safekit-docs/wp-content/uploads/2024/03/04-module-new.png" alt="Choose the module for IIS">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/36-module-farm-config-edit-1.jpg" alt="Enter the IIS farm module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/35-module-iis-edit-script-1.png" alt="Enter the IIS module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/07-module-encryption-1.png" alt="Communication encryption of the IIS module">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/08-module-save-1.png" alt="Save and apply the IIS module configuration">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/09-module-save-check-1.png" alt="Check the IIS module configuration success">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/11-monitoring-farm-stop-stop-start.png" alt="Start the IIS cluster on both nodes">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/15-monitoring-up-up.png" alt="The IIS cluster is started">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/appli-19.png" alt="Test the virtual IP address of IIS with the mosaic">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/32-snapshots-farm.png" alt="Take the IIS snaphots for support">



<!-- END INSERT: insert-safekit-82-farm-configuration-en lang="en" display="content" querystring="app=IIS&amp;mod=iis_farm" -->
