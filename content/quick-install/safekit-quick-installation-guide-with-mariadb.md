...
<a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_windows/mysql.safe" download="mysql.safe">⬇️ Download mysql.safe (Windows) ></a> 
...
<a class="btn-download" href="/wp-content/uploads/downloads_safekit/version-82/modules_linux/mysql.safe" download="mysql.safe">⬇️ Download mysql.safe (Linux) ></a> 
...
<img src="/wp-content/uploads/2024/03/01-login-large.png" alt="Start the SafeKit web console to configure the MariaDB cluster">
...
<img src="/wp-content/uploads/2024/03/02-cluster-edit.png" alt="Enter the nodes of the MariaDB cluster">
...
<img src="/wp-content/uploads/2024/03/04-module-new.png" alt="Choose the module for MariaDB">
...
<img src="/wp-content/uploads/2025/05/05-module-mirror-edit-config-3.png" alt="Enter the MariaDB module settings">
...
<img src="/wp-content/uploads/2025/05/28-module-sqlserver-edit-script-3.png" alt="Enter the MariaDB module settings">
...
<img src="/wp-content/uploads/2025/05/07-module-encryption-1.png" alt="Communication encryption of the MariaDB module">
...
<img src="/wp-content/uploads/2025/05/08-module-save-1.png" alt="Save and apply the MariaDB module configuration">
...
<img src="/wp-content/uploads/2025/05/09-module-save-check-1.png" alt="Check the MariaDB module configuration success">
...
<div class="callout callout-warning"><img src="/wp-content/uploads/2022/07/warning-small.png" alt="Warning"><span>It is also assumed that the MariaDB application is stopped on node 1 so that SafeKit installs the replication mechanisms and then starts the application in the `start_prim` script.</span></div>
...
<img src="/wp-content/uploads/2024/03/10-monitoring-mirror-stop-stop-prim.png" alt="Start as primary the MariaDB node with the up-to-date data">
...
<img src="/wp-content/uploads/2024/03/12-monitoring-alone-stop.png" alt="The first MariaDB node starts as primary and becomes ALONE">
...
<img src="/wp-content/uploads/2024/03/13-monitoring-alone-stop-start.png" alt="Start the MariaDB node 2">
...
<div class="callout callout-warning"><img src="/wp-content/uploads/2022/07/warning-small.png" alt="Warning"><span>Components that are clients of MariaDB services must be configured with the virtual IP address. The configuration can be done with a DNS name (if a DNS name has been created and associated with the virtual IP address).</span></div>


<img src="/wp-content/uploads/2024/03/14-monitoring-prim-second.png" alt="The MariaDB node 2 is SECOND (green)">
...
<img src="/wp-content/uploads/2024/03/16-monitoring-prim-second-stop.png" alt="Stop the MariaDB module on the PRIM server">
...
<img src="/wp-content/uploads/2024/03/30-snapshots-mirror.png" alt="Take the MariaDB snaphots for support">
