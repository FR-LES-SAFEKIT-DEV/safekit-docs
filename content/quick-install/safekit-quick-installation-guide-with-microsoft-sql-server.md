...
<!-- BEGIN INSERT: insert-safekit-mirror-guide-en lang="en" display="content" querystring="app=Microsoft SQL Server&amp;mod=sqlserver" -->
 

## High Availability Quick Installation Guide for Microsoft SQL Server {#quick-guide}

This guide explains how to set up a **mirror cluster** for Microsoft SQL Server using SafeKit, ensuring automatic failover and synchronous replication without the need for shared storage. 
...
### 2\. Installation
  ...
  * **Module:** Download the pre-configured `sqlserver.safe` application module.


### 3\. Configuration

  * **Web Console:** Configure the specific folders containing the Microsoft SQL Server files.
  * **Monitoring:** Start monitoring and protecting the Microsoft SQL Server application.
...
<!-- END INSERT: insert-safekit-mirror-guide-en lang="en" display="content" querystring="app=Microsoft SQL Server&amp;mod=sqlserver" -->
 

## Overview of the SafeKit / Microsoft SQL Server solution

For a detailed overview of the solution, see **[The Simplest Microsoft SQL Server High Availability: 2-Node Synchronous Replication& Failover](</safekit-docs/solutions/sql-server-high-availability-synchronous-replication-failover/>)**.
...
<!-- BEGIN INSERT: insert-safekit-installation-package-windows-en lang="en" display="content" querystring="app=Microsoft SQL Server&amp;mod=sqlserver" -->
...
<!-- END INSERT: insert-safekit-installation-package-windows-en lang="en" display="content" querystring="app=Microsoft SQL Server&amp;mod=sqlserver" -->
 


<!-- BEGIN INSERT: insert-safekit-82-installation-module-windows-en lang="en" display="content" querystring="app=Microsoft SQL Server&amp;mod=sqlserver" -->
 

### Module installation on Windows

  * Download the sqlserver.safe module. The module is free. It contains the files userconfig.xml and the restart scripts.
  * Put **sqlserver.safe** under **C:/safekit/Application_Modules/generic**.


<a class="btn-download" href="/safekit-docs/wp-content/uploads/downloads_safekit/version-82/modules_windows/sqlserver.safe" download="sqlserver.safe">⬇️ Download sqlserver.safe (Windows) ></a> 


<!-- END INSERT: insert-safekit-82-installation-module-windows-en lang="en" display="content" querystring="app=Microsoft SQL Server&amp;mod=sqlserver" -->
 

## Step by step configuration of the SafeKit / Microsoft SQL Server solution


<!-- BEGIN INSERT: insert-safekit-82-configuration-en lang="en" display="content" querystring="app=Microsoft SQL Server&amp;mod=sqlserver" -->
 

### Prerequisites

  * Microsoft SQL Server application installed on 2 nodes.
...
<img src="/safekit-docs/wp-content/uploads/2024/03/01-login-large.png" alt="Start the SafeKit web console to configure the Microsoft SQL Server cluster">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/02-cluster-edit.png" alt="Enter the nodes of the Microsoft SQL Server cluster">


### 3\. Select a module

  * In `New module`, click on the `sqlserver.safe` module.
...
<img src="/safekit-docs/wp-content/uploads/2024/03/04-module-new.png" alt="Choose the module for Microsoft SQL Server">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/05-module-mirror-edit-config-3.png" alt="Enter the Microsoft SQL Server module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/28-module-sqlserver-edit-script-3.png" alt="Enter the Microsoft SQL Server module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/07-module-encryption-1.png" alt="Communication encryption of the Microsoft SQL Server module">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/08-module-save-1.png" alt="Save and apply the Microsoft SQL Server module configuration">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/09-module-save-check-1.png" alt="Check the Microsoft SQL Server module configuration success">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/10-monitoring-mirror-stop-stop-prim.png" alt="Start as primary the Microsoft SQL Server node with the up-to-date data">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/12-monitoring-alone-stop.png" alt="The first Microsoft SQL Server node starts as primary and becomes ALONE">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/13-monitoring-alone-stop-start.png" alt="Start the Microsoft SQL Server node 2">
...
<div class="callout callout-warning"><img src="/safekit-docs/wp-content/uploads/2022/07/warning-small.png" alt="Warning"><span>Components that are clients of Microsoft SQL Server services must be configured with the virtual IP address. The configuration can be done with a DNS name (if a DNS name has been created and associated with the virtual IP address).</span></div>


<img src="/safekit-docs/wp-content/uploads/2024/03/14-monitoring-prim-second.png" alt="The Microsoft SQL Server node 2 is SECOND (green)">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/16-monitoring-prim-second-stop.png" alt="Stop the Microsoft SQL Server module on the PRIM server">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/30-snapshots-mirror.png" alt="Take the Microsoft SQL Server snaphots for support">



<!-- END INSERT: insert-safekit-82-configuration-en lang="en" display="content" querystring="app=Microsoft SQL Server&amp;mod=sqlserver" -->
