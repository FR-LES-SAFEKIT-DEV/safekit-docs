...
<!-- BEGIN INSERT: insert-safekit-mirror-guide-en lang="en" display="content" querystring="app=Nedap&amp;mod=nedap" -->
 

## High Availability Quick Installation Guide for Nedap {#quick-guide}

This guide explains how to set up a **mirror cluster** for Nedap using SafeKit, ensuring automatic failover and synchronous replication without the need for shared storage. 
...
### 2\. Installation
  ...
  * **Module:** Download the pre-configured `nedap.safe` application module.


### 3\. Configuration

  * **Web Console:** Configure the specific folders containing the Nedap files.
  * **Monitoring:** Start monitoring and protecting the Nedap application.
...
<!-- END INSERT: insert-safekit-mirror-guide-en lang="en" display="content" querystring="app=Nedap&amp;mod=nedap" -->
 

## Overview of the SafeKit / Nedap solution

The solution is described here: **[The Simplest Nedap High Availability: 2-Node Synchronous Replication& Failover](</safekit-docs/solutions/nedap-high-availability-synchronous-replication-failover/>)**.

## Installation of the SafeKit / Nedap solution on Windows (nedap.safe)

**All details on the [configuration of Nedap AOES and SQL with SafeKit are in this document](</safekit-docs/wp-content/uploads/documents/NEDAP_AEOS_CLUSTER_SAFEKIT.pdf>).**
...
<div class="callout"><img src="/safekit-docs/wp-content/uploads/2022/07/note.png" alt="Note"><span>Note: SQL Server can be external. In this case, at step 4 during the step by step configuration:</span></div>
...
You can implement redundancy of the external SQL Server with [SafeKit and the sqlserver.safe module](</safekit-docs/solutions/sql-server-high-availability-synchronous-replication-failover/>). In this case, configure the connection of Nedap AEOS to SQL with the virtual IP address of the sqlserver.safe module.


<!-- BEGIN INSERT: insert-safekit-installation-package-windows-en lang="en" display="content" querystring="app=Nedap AEOS and SQL&amp;mod=nedap" -->
...
<!-- END INSERT: insert-safekit-installation-package-windows-en lang="en" display="content" querystring="app=Nedap AEOS and SQL&amp;mod=nedap" -->
 


<!-- BEGIN INSERT: insert-safekit-82-installation-module-windows-en lang="en" display="content" querystring="app=Nedap AEOS and SQL&amp;mod=nedap" -->
 

### Module installation on Windows

  * Download the nedap.safe module. The module is free. It contains the files userconfig.xml and the restart scripts.
  * Put **nedap.safe** under **C:/safekit/Application_Modules/generic**.


<a class="btn-download" href="/safekit-docs/wp-content/uploads/downloads_safekit/version-82/modules_windows/nedap.safe" download="nedap.safe">⬇️ Download nedap.safe (Windows) ></a> 


<!-- END INSERT: insert-safekit-82-installation-module-windows-en lang="en" display="content" querystring="app=Nedap AEOS and SQL&amp;mod=nedap" -->
 

## Step by step configuration of the SafeKit / Nedap solution


<!-- BEGIN INSERT: insert-safekit-82-configuration-en lang="en" display="content" querystring="app=Nedap AEOS and SQL&amp;mod=nedap" -->
 

### Prerequisites

  * Nedap AEOS and SQL application installed on 2 nodes.
...
<img src="/safekit-docs/wp-content/uploads/2024/03/01-login-large.png" alt="Start the SafeKit web console to configure the Nedap AEOS and SQL cluster">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/02-cluster-edit.png" alt="Enter the nodes of the Nedap AEOS and SQL cluster">


### 3\. Select a module

  * In `New module`, click on the `nedap.safe` module.
...
<img src="/safekit-docs/wp-content/uploads/2024/03/04-module-new.png" alt="Choose the module for Nedap AEOS and SQL">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/05-module-mirror-edit-config-3.png" alt="Enter the Nedap AEOS and SQL module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/28-module-sqlserver-edit-script-3.png" alt="Enter the Nedap AEOS and SQL module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/07-module-encryption-1.png" alt="Communication encryption of the Nedap AEOS and SQL module">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/08-module-save-1.png" alt="Save and apply the Nedap AEOS and SQL module configuration">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/09-module-save-check-1.png" alt="Check the Nedap AEOS and SQL module configuration success">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/10-monitoring-mirror-stop-stop-prim.png" alt="Start as primary the Nedap AEOS and SQL node with the up-to-date data">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/12-monitoring-alone-stop.png" alt="The first Nedap AEOS and SQL node starts as primary and becomes ALONE">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/13-monitoring-alone-stop-start.png" alt="Start the Nedap AEOS and SQL node 2">
...
<div class="callout callout-warning"><img src="/safekit-docs/wp-content/uploads/2022/07/warning-small.png" alt="Warning"><span>Components that are clients of Nedap AEOS and SQL services must be configured with the virtual IP address. The configuration can be done with a DNS name (if a DNS name has been created and associated with the virtual IP address).</span></div>


<img src="/safekit-docs/wp-content/uploads/2024/03/14-monitoring-prim-second.png" alt="The Nedap AEOS and SQL node 2 is SECOND (green)">
...
### 13\. Testing
  ...
  * And with Microsoft Management Console (MMC) on Windows or with command lines on Linux, check the failover of Nedap AEOS and SQL services (stopped on node 1 in the `stop_prim` script and started on node 2 in the `start_prim` script).
...
<img src="/safekit-docs/wp-content/uploads/2024/03/16-monitoring-prim-second-stop.png" alt="Stop the Nedap AEOS and SQL module on the PRIM server">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/30-snapshots-mirror.png" alt="Take the Nedap AEOS and SQL snaphots for support">



<!-- END INSERT: insert-safekit-82-configuration-en lang="en" display="content" querystring="app=Nedap AEOS and SQL&amp;mod=nedap" -->
