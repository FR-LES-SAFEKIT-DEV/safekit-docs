---
title: "NGINX Network Load Balancing & Failover: Install the SafeKit farm.safe Module"
slug: "safekit-quick-installation-guide-with-nginx-with-network-load-balancing-and-failover"
canonical: "https://safekit.eviden.com/quick-install/safekit-quick-installation-guide-with-nginx-with-network-load-balancing-and-failover/"
...
lang: "en"
topics: "High Availability Quick Installation Guide for NGINX, SafeKit High Availability Limitations, Overview of the SafeKit / NGINX solution, Installation of the SafeKit / NGINX solution on Windows and Linux (farm.safe), Step by step configuration of the SafeKit / NGINX solution, Demonstration of the SafeKit farm solution, 🔍 SafeKit High Availability Navigation Hub"
---

# NGINX Network Load Balancing & Failover: Install the SafeKit farm.safe Module


<!-- BEGIN INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=NGINX&amp;mod=farm" -->
 

## High Availability Quick Installation Guide for NGINX {#quick-guide}

This guide explains how to set up a **farm cluster** for NGINX using SafeKit, ensuring network load balancing and automatic failover.
...
### 3\. Configuration
  ...
  * **Web Console:** Configure the NGINX farm cluster.
  * **Monitoring:** Start monitoring and protecting the NGINX application.
...
<!-- END INSERT: insert-safekit-farm-guide-en lang="en" display="content" querystring="app=NGINX&amp;mod=farm" -->
 

## Overview of the SafeKit / NGINX solution

The solution is described here: **[SafeKit: All-in-One NGINX Load Balancing& High Availability Software](</safekit-docs/solutions/nginx-the-simplest-load-balancing-cluster-with-failover/>)**.

## Installation of the SafeKit / NGINX solution on Windows and Linux (farm.safe)
...
<!-- BEGIN INSERT: insert-safekit-installation-package-windows-en lang="en" display="content" querystring="app=NGINX&amp;mod=farm&amp;farm" -->
...
<!-- END INSERT: insert-safekit-installation-package-windows-en lang="en" display="content" querystring="app=NGINX&amp;mod=farm&amp;farm" -->
 


<!-- BEGIN INSERT: insert-safekit-installation-package-linux-en lang="en" display="content" querystring="app=NGINX&amp;mod=farm&amp;farm" -->
...
<!-- END INSERT: insert-safekit-installation-package-linux-en lang="en" display="content" querystring="app=NGINX&amp;mod=farm&amp;farm" -->
...
<!-- BEGIN INSERT: insert-safekit-82-farm-configuration-en lang="en" display="content" querystring="app=NGINX&amp;mod=farm" -->
 

### Prerequisites

  * NGINX application installed on 2 nodes (or more).
...
<img src="/safekit-docs/wp-content/uploads/2024/03/01-login-large.png" alt="Start the SafeKit web console to configure the NGINX cluster">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/02-cluster-edit.png" alt="Enter the nodes of the NGINX cluster">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/04-module-new.png" alt="Choose the module for NGINX">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/36-module-farm-config-edit-1.jpg" alt="Enter the NGINX farm module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/35-module-iis-edit-script-1.png" alt="Enter the NGINX module settings">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/07-module-encryption-1.png" alt="Communication encryption of the NGINX module">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/08-module-save-1.png" alt="Save and apply the NGINX module configuration">
...
<img src="/safekit-docs/wp-content/uploads/2025/05/09-module-save-check-1.png" alt="Check the NGINX module configuration success">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/11-monitoring-farm-stop-stop-start.png" alt="Start the NGINX cluster on both nodes">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/15-monitoring-up-up.png" alt="The NGINX cluster is started">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/appli-19.png" alt="Test the virtual IP address of NGINX with the mosaic">
...
<img src="/safekit-docs/wp-content/uploads/2024/03/32-snapshots-farm.png" alt="Take the NGINX snaphots for support">



<!-- END INSERT: insert-safekit-82-farm-configuration-en lang="en" display="content" querystring="app=NGINX&amp;mod=farm" -->
